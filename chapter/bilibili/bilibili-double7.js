var __reflect = this && this.__reflect || function (t, e, n) {
    ...
    if (null != t && "function" == typeof Object.getOwnPropertySymbols) for (var r = 0, a = Object.getOwnPropertySymbols(t); r < a.length; r++) e.indexOf(a[r]) < 0 && (n[a[r]] = t[a[r]]);
    return n
}, GAL;
!function (t) {
    var e = 16, n = 0, a = 4, r = 6, i = 8, o = 12, c = function () {
        function t() {
            var t = this;
            this.onMessage = null, this.ws = null, this.textDecoder = this.getDecoder(), this.textEncoder = this.getEncoder(), this.heartbeatInterval = 0, this.timestamp = Date.now(), this.connect = function () {
                t.ws = new WebSocket("ws://broadcastlv.chat.bilibili.com:4090/sub"), t.ws.binaryType = "arraybuffer", t.ws.onopen = t.handleOpen, t.ws.onmessage = t.handleMessage, t.ws.onclose = t.handleClose, t.ws.onerror = t.handleError
            }, this.handleOpen = function () {
                t.auth()
            }, this.handleMessage = function (e) {
                var c = e.data, s = new DataView(c, 0), u = s.getInt32(n), f = s.getInt16(a),
                    h = (s.getInt16(r), s.getInt32(i));
                s.getInt32(o);
                switch (h) {
                    case 8:
                        t.heartbeat(), t.heartbeatInterval = setInterval(t.heartbeat, 1e4);
                        break;
                    case 3:
                        break;
                    case 5:
                        for (var l = s, d = c, g = void 0, y = 0; y < d.byteLength; y += u) {
                            u = l.getInt32(y), f = l.getInt16(y + a), g = t.textDecoder.decode(d.slice(y + f, y + u));
                            try {
                                var m = JSON.parse(g), w = m.CMD, p = m.Info;
                                m.RoomID;
                                "ACT" === w && Date.now() - t.timestamp >= 600 && (t.onMessage(p), t.timestamp = Date.now())
                            } catch (x) {
                            }
                        }
                }
                ...
                var c = new ArrayBuffer(e), s = new DataView(c, 0);
                s.setInt32(n, e), s.setInt16(a, e), s.setInt16(r, 1), s.setInt32(i, 2), s.setInt32(o, 1), t.ws.send(c)
            }
        }
        ...
        return t.prototype.open = function (t) {
            ...
            var t = JSON.stringify({uid: 0, roomid: 5078459}), c = new ArrayBuffer(e), s = new DataView(c, 0),
                u = this.textEncoder.encode(t);
            s.setInt32(n, e + u.byteLength), s.setInt16(a, e), s.setInt16(r, 1), s.setInt32(i, 7), s.setInt32(o, 1), this.ws.send(this.mergeArrayBuffer(c, u))
        }, t.prototype.mergeArrayBuffer = function (t, e) {
            var n = new Uint8Array(t), a = new Uint8Array(e), r = new Uint8Array(t.byteLength + e.byteLength);
            return r.set(n, 0), r.set(a, t.byteLength), r.buffer
        }, t.prototype.char2ab = function (t) {
            for (var e = new ArrayBuffer(t.length), n = new Uint8Array(e), a = 0; a < t.length; a += 1) n[a] = t[a];
            return e
            ...
            return "undefined" != typeof TextEncoder ? new TextEncoder : {
                encode: function (t) {
                    for (var e = new ArrayBuffer(t.length), n = new Uint8Array(e), a = 0, r = t.length; r > a; a += 1) n[a] = t.charCodeAt(a);
                    return e
                }
            }
        }, t
    }();
    t.WS = c, __reflect(c.prototype, "GAL.WS")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = function () {
        function t() {
            var t = this;
            this.isEnd = !0, this.tw = [], this.states = [], this.init = function (e, n, a) {
                t.tw = [], t.states = [], t.animation = e, n instanceof Array ? t.target = n : t.target = [n], t.target.forEach(function (e) {
                    t.tw.push(egret.Tween.get(e)), t.states.push(!1)
                }), t.callback = a
            }, this.check = function () {
                return t.isEnd
            }, this.start = function (e) {
                t.isEnd = !1, t.nextTransform = e, t.tw.forEach(function (e, n) {
                    e.to(t.nextTransform, t.animation.duration, t.animation.func).call(function () {
                        t.states[n] = !0;
                        var e = t.states.reduce(function (t, e) {
                            return t && e
                        });
                        e && (t.isEnd = !0, t.callback && t.callback(t.nextTransform))
                    })
                })
            }, this.end = function () {
                t.target.forEach(function (e, n) {
                    t.tw[n] && egret.Tween.pauseTweens(e), Object.keys(t.nextTransform).forEach(function (n) {
                        e[n] = t.nextTransform[n]
                    })
                }), t.isEnd = !0, t.callback && t.callback(t.nextTransform)
            }
        }

        return t
    }();
    t.Animator = e, __reflect(e.prototype, "GAL.Animator")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    t.MAX_GRID = 6, t.CHAR_SIZE_LUT = {
        scale: {exSmall: .2, small: .6, middle: 1, large: 1.6, exLarge: 2},
        yOffset: {exSmall: 32, small: 64, middle: 84, large: 96, exLarge: 128},
        initFromOffset: {exSmall: .1, small: .2, middle: .3, large: .4, exLarge: .4}
    }, t.CHAR_ATTRS = {}, t.DIALOG_SIZE_LUT = {
        touchIcon: {bg: "elements.touch", width: 64, right: 12, bottom: 12},
        adv: {
            width: 540,
            height: 287,
            nameLeft: 128,
...
!function (t) {
    var e = function () {
        function t() {
            var t = this;
            this.isEnd = !0, this.start = function (e, n, a, r) {
                if (t.isEnd = !1, t.parent = a, t.preTarget = e, t.nextTarget = n, t.nextTarget.alpha = 0, void 0 !== r ? t.parent.addChildAt(t.nextTarget, r) : t.parent.addChild(t.nextTarget), "fade" === t.transition.type) {
                    var i = t.transition.duration;
                    egret.Tween.get(t.preTarget).to({alpha: 0}, .8 * i), egret.Tween.get(t.nextTarget).wait(.3 * i).to({alpha: 1}, .7 * i).call(function () {
                        return t.end()
                    })
                }
                ...
                t.isEnd || (egret.Tween.pauseTweens(t.preTarget), egret.Tween.pauseTweens(t.nextTarget), t.parent.removeChild(t.preTarget), t.nextTarget.alpha = 1, t.isEnd = !0, t.preTarget = null, t.nextTarget = null)
            }
        }
    ...
    t.Transition = e, __reflect(e.prototype, "GAL.Transition")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = function () {
        function t(t, e) {
            void 0 === t && (t = !1), void 0 === e && (e = !1), this.multiple = !1, this.audio = {
                audio: null,
                channel: null,
                position: 0
            }, this.multiple = t, this.defaultLoop = e
        }

        return t.prototype.play = function (t, e) {
            this.multiple || (this.loop = void 0 === e ? this.defaultLoop : e, this.audio.channel && this.audio.channel.stop(), this.audio.audio = RES.getRes(t), this.audio.channel = this.audio.audio.play(0, this.loop ? 0 : 1))
        }, t.prototype.pause = function () {
            this.multiple || (this.audio.position = this.audio.channel.position, this.audio.channel.stop(), this.audio.channel = null)
    ...
    t.Audio = e, __reflect(e.prototype, "GAL.Audio")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = function (e) {
        function n() {
            ...
            return n.isEnd = !1, n.animation = {
                duration: 400, func: function (t) {
                    return t
                }
            }, n.direction = {direction: "right", offset: 128}, n.customTransform = !1, n.animator = new t.Animator, n
        }

        return __extends(n, e), n.prototype.addToScene = function (t) {
            this.scene = t, this.scene.layers.branch.addChild(this)
        }, n.prototype.open = function (e, n, a) {
            var r = this;
            void 0 === n && (n = !0), void 0 === a && (a = {}), this.isEnd = !1, this.scene.hideDialog();
            var i = new egret.Bitmap;
            i.texture = RES.getRes("" + t.BRANCH_ATTRS.mask), this.addChild(i);
            var o = new egret.DisplayObjectContainer;
            this.addChild(o);
            var c = 0, s = 0;
            e.forEach(function (e, i) {
                var c = e.content, u = e.callback, f = e.bg, h = e.transform, l = new egret.DisplayObjectContainer,
                    d = new egret.Bitmap;
                d.texture = RES.getRes("" + (f || t.BRANCH_ATTRS.bg));
                var g = new egret.TextField;
                if (l.touchEnabled = !0, r.customTransform) {
                    g.text = c || "", g.size = h.size || t.BRANCH_ATTRS.fontSize, l.width = h.width, d.width = h.width, g.width = h.width, l.height = h.height, d.height = h.height, g.textAlign = h.textAlign || egret.HorizontalAlign.CENTER, g.lineSpacing = h.lineSpacing || t.BRANCH_ATTRS.lineSpace, g.textColor = h.color || t.BRANCH_ATTRS.color, g.y = (h.height - g.height) / 2;
                    var y = h.x || t.BRANCH_ATTRS.branchAligh;
                    "number" == typeof y ? l.x = y : y === egret.HorizontalAlign.CENTER ? l.x = (t.BRANCH_ATTRS.branchWidth - t.BRANCH_ATTRS.textWidth) / 2 : y === egret.HorizontalAlign.LEFT ? l.x = 0 : y === egret.HorizontalAlign.RIGHT && (l.x = r.stage.stageWidth - l.width), l.y = h.y, l.rotation = h.rotation || 0
                } else {
                    g.text = c, g.size = a.size || t.BRANCH_ATTRS.fontSize, l.width = a.width || t.BRANCH_ATTRS.branchWidth, d.width = a.width || t.BRANCH_ATTRS.branchWidth, g.width = a.width || t.BRANCH_ATTRS.textWidth, d.height = l.width / d.texture.textureWidth * d.texture.textureHeight, g.textAlign = a.textAlign || t.BRANCH_ATTRS.textAlign, g.lineSpacing = a.lineSpacing || t.BRANCH_ATTRS.lineSpace, g.x = t.BRANCH_ATTRS.textX || 0, g.y = t.BRANCH_ATTRS.textY || (d.height - g.height) / 2;
                    var m = a.x || t.BRANCH_ATTRS.branchAligh;
                    "number" == typeof m ? l.x = m : m === egret.HorizontalAlign.CENTER ? l.x = (r.stage.stageWidth - t.BRANCH_ATTRS.branchWidth) / 2 : m === egret.HorizontalAlign.LEFT ? l.x = 0 : m === egret.HorizontalAlign.RIGHT && (l.x = r.stage.stageWidth - l.width), l.y = s, l.height = (a.height || d.height) + 2 * t.BRANCH_ATTRS.branchPadding, s += l.height + t.BRANCH_ATTRS.branchSpace
                }
                l.addEventListener(egret.TouchEvent.TOUCH_TAP, function () {
                    u(i, c), n && r.close()
                }, r), l.addChild(d), l.addChild(g), o.addChild(l)
            });
            var u = this.stage.stageWidth, f = this.stage.stageHeight;
            this.customTransform ? (o.width = u, o.height = f) : (c = s, s = (f - c) / 2, o.y = s), this.customTransform = !1, o.alpha = 0;
            var h = this.direction, l = h.offset, d = h.direction, g = o.x, y = o.y;
            return "left" === d ? o.x -= l : "right" === d ? o.x += l : "top" === d ? o.y -= l : "bottom" === d && (o.y += l), this.animator.init(this.animation, o), this.animator.start({
                alpha: 1,
                x: g,
                y: y
            }), {
            ...
            return void 0 === t && (t = 500), void 0 === e && (e = function (t) {
                return t
            }), this.animation = {duration: t, func: e}, this
        }, n.prototype.custom = function () {
            return this.customTransform = !0, this
        }, n.prototype.from = function (t, e) {
            return void 0 === e && (e = 24), this.direction.direction = t, e && (this.direction.offset = e), this
        }, n.prototype.close = function () {
            this.removeChildren(), this.isEnd = !0
        }, n
    }(egret.DisplayObjectContainer);
    t.Branch = e, __reflect(e.prototype, "GAL.Branch")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = function (e) {
        function n() {
            ...
            return n.bg = new egret.Bitmap, n.titleLayers = {
            ...
            }, n.sex = 0, n.animationEnd = !1, n.callback = null, n.handleSelectBoy = function () {
                if (0 !== n.sex) {
                    var t = egret.Tween.get(n.sexLayers.boySelect), e = egret.Tween.get(n.sexLayers.girlSelect),
                        a = egret.Tween.get(n.sexLayers.frame);
                    e.to({scaleX: 1.1, scaleY: 1.1}, 400, egret.Ease.quadInOut).call(function () {
                        n.sexLayers.girlSelect.texture = RES.getRes("elements.sex-icon-no")
                    }).to({scaleX: 1, scaleY: 1}, 300, egret.Ease.backInOut), t.wait(300).to({
                        scaleX: 1.2,
                        scaleY: 1.2
                        ...
                        scaleX: 1,
                        scaleY: 1
                    }, 400, egret.Ease.backInOut), a.to({alpha: 0}, 400, egret.Ease.quadInOut).call(function () {
                        n.sexLayers.frame.scaleX = .6, n.sexLayers.frame.scaleY = .6, n.sexLayers.frame.x = n.sexLayers.boySelect.x
                    }).to({alpha: 1, scaleX: 1, scaleY: 1}, 600, egret.Ease.backInOut).to({
                        scaleX: .95,
                        scaleY: .95
                    }, 150, function (t) {
                        return t
                    }).to({scaleX: 1.05, scaleY: 1.05}, 150, function (t) {
                        return t
                    }).to({scaleX: 1, scaleY: 1}, 150, function (t) {
                        return t
                    }).call(function () {
                        n.sex = 0
                    })
                ...
                if (1 !== n.sex) {
                    var t = egret.Tween.get(n.sexLayers.boySelect), e = egret.Tween.get(n.sexLayers.girlSelect),
                        a = egret.Tween.get(n.sexLayers.frame);
                    t.to({scaleX: 1.1, scaleY: 1.1}, 400, egret.Ease.quadInOut).call(function () {
                        n.sexLayers.boySelect.texture = RES.getRes("elements.sex-icon-no")
                    }).to({scaleX: 1, scaleY: 1}, 300, egret.Ease.backInOut), e.wait(300).to({
                        scaleX: 1.2,
                        scaleY: 1.2
                    }, 600, egret.Ease.backInOut).call(function () {
                        ...
                        n.sexLayers.frame.scaleX = .6, n.sexLayers.frame.scaleY = .6, n.sexLayers.frame.x = n.sexLayers.girlSelect.x
                    }).to({alpha: 1, scaleX: 1, scaleY: 1}, 600, egret.Ease.backInOut).to({
                        scaleX: .95,
                        scaleY: .95
                    }, 150, function (t) {
                ...
                t.post(t.config.domain.sex, {sex: n.sex}).then(function (t) {
                    var e = t.data, a = e.code, r = e.msg;
                    return 0 !== a ? void alert("出错啦：" + r) : (n.animationEnd = !0, void n.callback(n.sex))
                })["catch"](function (t) {
                    alert("出了点问题呢，请重试哦~")
                })
            }, n.bg.name = "bg", n.addChild(n.bg), n.titleLayers.two.name = "22", n.titleLayers.three.name = "33", n.titleLayers.tv.name = "tv", n.titleLayers.bg.name = "bg", n.titleLayers.logo.name = "logo", n.layers.title.addChild(n.titleLayers.bg), n.layers.title.addChild(n.titleLayers.tv), n.layers.title.addChild(n.titleLayers.three), n.layers.title.addChild(n.titleLayers.two), n.layers.title.addChild(n.titleLayers.logo), n.sexLayers.boy.name = "boy", n.sexLayers.girl.name = "girl", n.sexLayers.confirm.name = "confirm", n.sexLayers.content.name = "content", n.sexLayers.title.name = "title", n.sexLayers.boyTip.name = "boyTip", n.sexLayers.girlTip.name = "girlTip", n.sexLayers.boySelect.name = "boySelect", n.sexLayers.girlSelect.name = "girlSelect", n.sexLayers.frame.name = "frame", n.layers.sex.addChild(n.sexLayers.title), n.layers.sex.addChild(n.sexLayers.content), n.layers.sex.addChild(n.sexLayers.frame), n.layers.sex.addChild(n.sexLayers.boy), n.layers.sex.addChild(n.sexLayers.girl), n.layers.sex.addChild(n.sexLayers.boyTip), n.layers.sex.addChild(n.sexLayers.girlTip), n.layers.sex.addChild(n.sexLayers.boySelect), n.layers.sex.addChild(n.sexLayers.girlSelect), n.layers.sex.addChild(n.sexLayers.confirm), n.layers.title.name = "title", n.layers.mask.name = "mask", n.layers.sex.name = "sex", n.addChild(n.layers.title), n.addChild(n.layers.mask), n.addChild(n.layers.sex), n
        }

        return __extends(n, e), n.prototype.addToStage = function (t) {
            this.originStage = t, this.addEventListener(egret.Event.ADDED_TO_STAGE, this.reset, this)
        }, n.prototype.init = function () {
            this.originStage.addChild(this)
        }, n.prototype.showTitle = function (t) {
            var e = this;
            void 0 === t && (t = function () {
            }), this.layers.title.visible = !0, this.animationEnd = !1, this.titleLayers.two.alpha = 0, this.titleLayers.three.alpha = 0, this.titleLayers.tv.alpha = 0, this.titleLayers.logo.alpha = 0;
            ...
            var o = egret.Tween.get(this.titleLayers.two), c = egret.Tween.get(this.titleLayers.three),
                s = egret.Tween.get(this.titleLayers.tv), u = egret.Tween.get(this.titleLayers.logo);
            return c.to({alpha: 1, y: a}, 700, egret.Ease.quadOut), o.wait(400).to({
                alpha: 1,
                y: n
            }, 700, egret.Ease.quadOut), s.wait(600).to({
                alpha: 1,
                y: r
            }, 600, egret.Ease.quadOut), u.wait(800).to({alpha: 1, y: i}, 700, egret.Ease.quadOut).call(function () {
                t(), e.animationEnd = !0
            }), {
                check: function () {
            ...
            var e = this;
            void 0 === t && (t = function () {
            }), this.layers.sex.visible = !0, this.layers.mask.visible = !0, this.animationEnd = !1, this.callback = t, this.layers.mask.alpha = 0, this.sexLayers.boy.alpha = 0, this.sexLayers.girl.alpha = 0, this.sexLayers.title.alpha = 0, this.sexLayers.content.alpha = 0, this.sexLayers.confirm.alpha = 0, this.sexLayers.boySelect.scaleX = 0, this.sexLayers.boySelect.scaleY = 0, this.sexLayers.boyTip.scaleX = 0, this.sexLayers.girlTip.scaleY = 0, this.sexLayers.girlSelect.scaleX = 0, this.sexLayers.girlSelect.scaleY = 0, this.sexLayers.frame.scaleX = .6, this.sexLayers.frame.scaleY = .6, this.sexLayers.frame.alpha = 0;
            ...
            var s = egret.Tween.get(this.layers.mask), u = egret.Tween.get(this.sexLayers.title),
                f = egret.Tween.get(this.sexLayers.content), h = egret.Tween.get(this.sexLayers.boy),
                l = egret.Tween.get(this.sexLayers.girl), d = egret.Tween.get(this.sexLayers.confirm),
                g = egret.Tween.get(this.sexLayers.boyTip), y = egret.Tween.get(this.sexLayers.girlTip),
                m = egret.Tween.get(this.sexLayers.boySelect), w = egret.Tween.get(this.sexLayers.girlSelect),
                p = egret.Tween.get(this.sexLayers.frame), x = egret.Tween.get(this.layers.title);
            return x.wait(400).to({y: -146}, 1e3, egret.Ease.quadOut).to({alpha: 0}, 500, egret.Ease.quadInOut).call(function () {
                e.layers.title.visible = !1, e.layers.mask.visible = !1
            }), s.to({alpha: 1, y: n}, 600, egret.Ease.quadOut), u.wait(200).to({
                alpha: 1,
                y: i
            }, 400, egret.Ease.quadOut), f.wait(200).to({
                alpha: 1,
                y: o
            }, 400, egret.Ease.quadOut), h.wait(600).to({
                alpha: 1,
                y: a
            }, 600, egret.Ease.quadOut), l.wait(800).to({
                alpha: 1,
                y: r
            }, 600, egret.Ease.quadOut), d.wait(1e3).to({
                alpha: 1,
                y: c
            }, 500, egret.Ease.quadOut), g.wait(1e3).to({
                scaleX: 1.2,
                scaleY: 1.2
            }, 600, egret.Ease.backInOut).to({scaleX: .9, scaleY: .9}, 200).to({
                scaleX: 1,
                scaleY: 1
            }, 200), y.wait(1e3).to({scaleX: 1, scaleY: 1}, 600, egret.Ease.backInOut).to({
                scaleX: .9,
                scaleY: .9
            }, 200).to({scaleX: 1, scaleY: 1}, 200), m.wait(1400).to({
                scaleX: 1.2,
                scaleY: 1.2
            }, 800, egret.Ease.backInOut).call(function () {
                e.sexLayers.boySelect.texture = RES.getRes("elements.sex-icon-ok")
            }).to({scaleX: 1, scaleY: 1}, 400, egret.Ease.backInOut), w.wait(1400).to({
                scaleX: 1,
                scaleY: 1
            }, 800, egret.Ease.backInOut), p.wait(1800).to({
                alpha: 1,
                scaleX: 1,
                scaleY: 1
            }, 600, egret.Ease.backInOut).to({scaleX: .95, scaleY: .95}, 150, function (t) {
                return t
            }).to({scaleX: 1.05, scaleY: 1.05}, 150, function (t) {
                return t
            }).to({scaleX: 1, scaleY: 1}, 150, function (t) {
                ...
                e.sexLayers.boy.addEventListener(egret.TouchEvent.TOUCH_TAP, e.handleSelectBoy, e), e.sexLayers.girl.addEventListener(egret.TouchEvent.TOUCH_TAP, e.handleSelectGirl, e), e.sexLayers.confirm.addEventListener(egret.TouchEvent.TOUCH_TAP, e.handleConfirm, e)
            }), {
                check: function () {
                    return e.animationEnd
                }, exec: function () {
            ...
            this.layers.title.visible = !1, this.layers.sex.visible = !1, this.layers.mask.visible = !1, this.animationEnd = !1, this.resetTitle(), this.resetSex()
        }, n.prototype.resetTitle = function () {
            var t = this.titleLayers, e = t.two, n = t.three, a = t.tv, r = (t.bg, t.logo), i = this.originStage,
                o = i.stageWidth, c = i.stageHeight;
            this.bg.texture = RES.getRes("elements.title-bg-blur"), this.bg.x = 0, this.bg.x = 0, this.layers.title.x = 0, this.layers.title.y = 0, this.layers.title.alpha = 1, this.titleLayers.two.texture = RES.getRes("cg.2233"), this.titleLayers.three.texture = RES.getRes("cg.moon"), this.titleLayers.tv.texture = RES.getRes("cg.bridge"), this.titleLayers.bg.texture = RES.getRes("elements.title-bg"), this.titleLayers.logo.texture = RES.getRes("elements.logo"), e.width = 1233, e.height = e.texture.textureHeight / e.texture.textureWidth * e.width, e.x = -480, e.y = c - e.height - 24, n.width = 884, n.height = n.texture.textureHeight / n.texture.textureWidth * n.width, n.x = -40, n.y = -260, a.width = 2548, a.height = a.texture.textureHeight / a.texture.textureWidth * a.width, a.x = 1500, a.y = -120, a.scaleX = -1, r.width = 4 * o / 5, r.height = r.texture.textureHeight / r.texture.textureWidth * r.width, r.x = o / 10, r.y = c - 128 - r.height
        }, n.prototype.resetSex = function () {
            var t = this.sexLayers, e = t.boy, n = t.girl, a = t.confirm, r = t.content, i = t.title, o = t.boySelect,
                c = t.girlSelect, s = t.frame, u = t.boyTip, f = t.girlTip, h = this.layers.mask, l = this.originStage,
                d = l.stageWidth, g = l.stageHeight;
            e.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.handleSelectBoy, this), n.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.handleSelectGirl, this), a.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.handleSelectBoy, this), e.touchEnabled = !0, n.touchEnabled = !0, a.touchEnabled = !0, h.texture = RES.getRes("elements.white-mask"), e.texture = RES.getRes("elements.sex-boy"), n.texture = RES.getRes("elements.sex-girl"), a.texture = RES.getRes("elements.confirm"), o.texture = RES.getRes("elements.sex-icon-no"), c.texture = RES.getRes("elements.sex-icon-no"), u.texture = RES.getRes("elements.sex-icon-boy"), f.texture = RES.getRes("elements.sex-icon-girl"), s.texture = RES.getRes("elements.sex-icon-frame"), i.text = "请选择性别", r.text = "只可以选择一次哦！", h.width = d, h.height = h.texture.textureHeight / h.texture.textureWidth * h.width, h.x = 0, h.y = g - h.height, i.width = d, i.size = 42, i.textAlign = egret.HorizontalAlign.CENTER, i.y = 0, r.width = d, r.size = 18, r.textAlign = egret.HorizontalAlign.CENTER, r.y = i.size + 16;
            var y = d / 28;
            e.width = 9 * y, e.height = e.texture.textureHeight / e.texture.textureWidth * e.width, e.x = 4 * y, e.y = r.y + 48, n.width = e.width, n.height = e.height, n.x = e.width + 6 * y, n.y = e.y, o.width = e.width / 6, o.height = o.texture.textureHeight / o.texture.textureWidth * o.width, o.anchorOffsetX = o.width / 2, o.anchorOffsetY = o.height / 2, o.x = e.x + e.width / 2, o.y = e.y + e.height - 128, c.width = o.width, c.height = o.height, c.anchorOffsetX = o.anchorOffsetX, c.anchorOffsetY = o.anchorOffsetY, c.x = n.x + n.width / 2, c.y = o.y, u.width = e.width / 4, u.height = u.texture.textureHeight / u.texture.textureWidth * u.width, u.anchorOffsetX = u.width / 2, u.anchorOffsetY = u.height / 2, u.x = e.x + e.width / 2, u.y = e.y + e.height - 256, f.width = u.width, f.height = u.height, f.anchorOffsetX = u.anchorOffsetX, f.anchorOffsetY = u.anchorOffsetY, f.x = n.x + n.width / 2, f.y = u.y, s.width = e.width + 36, s.height = s.texture.textureHeight / s.texture.textureWidth * s.width, s.anchorOffsetX = s.width / 2, s.anchorOffsetY = s.height / 2, s.x = o.x, s.y = 80 + e.height / 2, a.width = d / 3, a.height = a.texture.textureHeight / a.texture.textureWidth * a.width, a.x = d / 3, a.y = e.y + e.height + 24, this.layers.sex.x = 0, this.layers.sex.y = (g - (a.y + a.height)) / 2
        }, n
    }(egret.DisplayObjectContainer);
    t.Title = e, __reflect(e.prototype, "GAL.Title")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = function (e) {
        function n(n, a, r, i, o, c, s, u) {
            void 0 === i && (i = 0), void 0 === o && (o = 0), void 0 === c && (c = 30), void 0 === s && (s = !0), void 0 === u && (u = !0);
            var f = e.call(this) || this;
            return f.showSize = "middle", f.position = {x: 0, y: 0}, f.nextAlpha = 1, f.direction = {
                direction: "right",
                duration: 600
            }, f.modified = {
                pos: !1,
                face: !1
            }, f.active = !1, f.animator = new t.Animator, f.transition = {
                duration: 500,
                type: "fade"
            }, f.faceTransActor = new t.Transition, f.posTransActor = new t.Transition, f.sayWithShow = !1, f.reset = function () {
                f.active = !1, f.animation = null
            }, f.draw = function () {
                f.scene.layers.chars.setChildIndex(f, 10), f.multiPos && f.modified.pos && (f.modified.pos = !1, f.modified.face = !0, f.active && f.animator.check() ? (f.prePos = f.posImg, f.posImg = new egret.Bitmap, f.posImg.texture = RES.getRes(f.resKey + "-" + f.posName + ".body"), f.posTransActor.start(f.prePos, f.posImg, f, 1)) : f.posImg.texture = RES.getRes(f.resKey + "-" + f.posName + ".body")), f.multiFace && f.modified.face && (f.modified.face = !1, f.active && f.animator.check() ? (f.preFace = f.faceImg, f.faceImg = new egret.Bitmap, f.faceImg.texture = RES.getRes(f.resKey + "-" + f.posName + "." + f.faceName), f.faceTransActor.start(f.preFace, f.faceImg, f, 3)) : f.faceImg.texture = RES.getRes(f.resKey + "-" + f.posName + "." + f.faceName)), f.multiPos || f.multiFace || (f.posImg.texture = RES.getRes("" + f.resKey));
                ...
                return f.animation ? (f.animator.init(f.animation, f), f.animator.start({
                    scaleX: e,
                    scaleY: e,
                    x: n,
                    y: a,
                    alpha: f.nextAlpha
                }), f.animation = null) : (f.scaleX = e, f.scaleY = e, f.x = n, f.y = a, f.alpha = f.nextAlpha), f.active = !0, {
                ...
                f.animator.check() || f.animator.end(), f.faceTransActor.check() || f.faceTransActor.end(), f.posTransActor.check() || f.posTransActor.end(), f.animation = null
            }, f.name = a, f.resKey = n, f.charName = a, t.CHAR_ATTRS[f.resKey] = {
                name: a,
                nameColor: i,
                wordsColor: o,
                bgPath: "dialog." + r + "-s",
                ...
                cps: c
            }, f.multiPos = s, f.multiFace = u, f.addEventListener(egret.Event.REMOVED_FROM_STAGE, f.reset, f), f
        }

        return __extends(n, e), n.prototype.addToScene = function (t) {
            this.scene = t, this.posImg = new egret.Bitmap, this.faceImg = new egret.Bitmap, this.prePos = new egret.Bitmap, this.preFace = new egret.Bitmap, this.addChild(this.posImg), this.addChild(this.faceImg), this.faceTransActor.init(this.transition), this.posTransActor.init(this.transition), this.active = !1
        }, n.prototype.rename = function (e) {
            return void 0 !== e ? t.CHAR_ATTRS[this.resKey].name = e : t.CHAR_ATTRS[this.resKey].name = this.charName, this
        }, n.prototype.say = function (t) {
            if (this.sayWithShow) {
                var e = this.show(), n = this.scene.dialog.say(this.resKey, t);
                return {
                    check: function () {
                        return e.check() && n.check()
                    }, exec: function () {
                        e.check() || e.exec(), n.check() || n.exec()
                    }
                }
            }
            return this.active && this.scene.layers.chars.setChildIndex(this, 10), this.scene.dialog.say(this.resKey, t)
        }, n.prototype.think = function (t) {
            if (this.sayWithShow) {
                var e = this.show(), n = this.scene.dialog.think(this.resKey, t);
                return {
                    check: function () {
                        return e.check() && n.check()
                    }, exec: function () {
            ...
            return this.animate(this.direction.duration), this.animator.init(this.animation, this, function () {
                e.scene.layers.chars.removeChild(e), e.reset()
            }), this.animator.start({x: r, y: i, alpha: 0}), {check: this.checkAnimation, exec: this.endAnimation}
        }, n.prototype.posture = function (t) {
            return this.modified.pos = this.posName !== t, this.posName = t, this
        }, n.prototype.face = function (t) {
            return this.modified.face = this.faceName !== t, this.faceName = t, this
        }, n.prototype.size = function (t) {
            return void 0 === t && (t = "middle"), this.showSize = t, this
        }, n.prototype.at = function (t, e) {
            return this.position.x = t, "number" == typeof e && (this.position.y = e), this
        }, n.prototype.opacity = function (t) {
            return this.nextAlpha = t, this
        }, n.prototype.from = function (t, e) {
            return void 0 === e && (e = 600), this.direction.direction = t, e && (this.direction.duration = e), this
        }, n.prototype["with"] = function (t, e) {
            return void 0 === t && (t = 800), void 0 === e && (e = "fade"), this.transition = {
                duration: t,
                type: e
            }, this.faceTransActor.init(this.transition), this.posTransActor.init(this.transition), this
        }, n.prototype.animate = function (t, e) {
            return void 0 === t && (t = 500), void 0 === e && (e = function (t) {
                return t
            }), this.animation = {duration: t, func: e}, this
    ...
    t.Character = e, __reflect(e.prototype, "GAL.Character")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = function (e) {
        function n() {
            ...
            n.layers = {
            ...
            }, n.onShare = null, n.onLetter = null, n.onRestart = null, n.onMovie = null, n.shareInfo = "《七夕之恋 - Double;7》：你又会邂逅谁呢？", n.handleShare = function () {
                n.onShare(n.shareInfo), n.shareDom.click()
                ...
                var e = n.originStage, a = e.stageWidth, r = e.stageHeight, i = n.layers, o = i.restart, c = i.letter,
                    s = i.share, u = i.movie, f = 0 === t.config.user.sex ? "g" : "b";
                c.texture = RES.getRes("elements.letter-" + f), s.texture = RES.getRes("elements.share"), u.texture = RES.getRes("elements.movie"), o.texture = RES.getRes("elements.restart");
                var h = 140;
                c.height = h, c.width = c.texture.textureWidth / c.texture.textureHeight * c.height, c.x = 0, c.y = r - h - 24, s.height = h, s.width = s.texture.textureWidth / s.texture.textureHeight * s.height, s.x = c.width + 64, s.y = c.y, u.height = h, u.width = u.texture.textureWidth / u.texture.textureHeight * u.height, u.x = s.x + s.width + 64, u.y = c.y, n.height = h, n.width = u.x + u.width, n.x = (a - n.width) / 2, n.y = 0, o.height = 48, o.width = o.texture.textureWidth / o.texture.textureHeight * o.height, o.x = a - n.x - o.width - 24, o.y = 24;
                var l = n.y;
                n.alpha = 0, n.y += 32;
                var d = document.getElementsByTagName("canvas")[0], g = parseInt(d.style.width, 10),
                    y = parseInt(d.style.height, 10), m = g / a, w = y / r;
                egret.Tween.get(n).to({alpha: 1, y: l}, 800, egret.Ease.quadInOut).call(function () {
                    n.friendDom.style.display = "block", n.friendDom.href = t.config.domain.letter + "/" + t.config.friend.id, n.movieDom.style.display = "block", n.movieDom.href = t.config.domain.movie, window.innerWidth < window.innerHeight ? (n.friendDom.style.left = (n.x + c.x) * m + "px", n.friendDom.style.top = c.y * w + "px", n.friendDom.style.width = c.width * m + "px", n.friendDom.style.height = c.height * w + "px", n.movieDom.style.left = (n.x + u.x) * m + "px", n.movieDom.style.top = u.y * w + "px", n.movieDom.style.width = u.width * m + "px", n.movieDom.style.height = u.height * w + "px") : (n.friendDom.style.bottom = (n.x + c.x) * m + "px", n.friendDom.style.left = c.y * w + "px", n.friendDom.style.height = c.width * m + "px", n.friendDom.style.width = c.height * w + "px", n.movieDom.style.bottom = (n.x + u.x) * m + "px", n.movieDom.style.left = u.y * w + "px", n.movieDom.style.height = u.width * m + "px", n.movieDom.style.width = u.height * w + "px")
                })
            };
            var a = n.layers, r = a.restart, i = a.letter, o = a.share, c = a.movie;
            return r.name = "restart", i.name = "letter", o.name = "share", c.name = "movie", o.touchEnabled = !0, o.addEventListener(egret.TouchEvent.TOUCH_END, n.handleShare, n), i.touchEnabled = !0, i.addEventListener(egret.TouchEvent.TOUCH_END, n.handleLetter, n), r.touchEnabled = !0, r.addEventListener(egret.TouchEvent.TOUCH_END, n.handleRestart, n), c.touchEnabled = !0, c.addEventListener(egret.TouchEvent.TOUCH_END, n.handleMovie, n), n.addChild(i), n.addChild(o), n.addChild(c), n.addChild(r), window.addEventListener("load", function () {
                n.shareDom = document.createElement("div"), n.shareDom.id = "share", n.shareDom.style.display = "none", document.body.appendChild(n.shareDom), n.friendDom = document.createElement("a"), n.friendDom.href = "", n.friendDom.target = "_blank", n.friendDom.id = "letter", n.friendDom.style.position = "fixed", n.friendDom.style.display = "none", n.friendDom.style.zIndex = "999", n.friendDom.style.opacity = "0", n.friendDom.addEventListener("click", function () {
                    t.report("letter", 0 === t.config.user.sex ? "boy" : "girl")
                }), document.body.appendChild(n.friendDom), n.movieDom = document.createElement("a"), n.movieDom.href = "", n.movieDom.target = "_blank", n.movieDom.id = "movie", n.movieDom.style.position = "fixed", n.movieDom.style.display = "none", n.movieDom.style.zIndex = "999", n.movieDom.style.opacity = "0", n.movieDom.addEventListener("click", function () {
                    t.report("movie", 0 === t.config.user.sex ? "boy" : "girl")
                }), document.body.appendChild(n.movieDom), $("document").ready(function () {
                    n.updateMessage()
                })
            }), n
        }
        ...
        return __extends(n, e), n.prototype.addToStage = function (t) {
            this.originStage = t, this.addEventListener(egret.Event.ADDED_TO_STAGE, this.init, this)
        }, n.prototype.updateMessage = function () {
            if (t.config.user && t.config.friend) if ("999999999999999" === t.config.user.path.join("")) ; else {
                var e = t.config.friend.name, n = 0 === t.config.user.sex ? "少女" : "少年";
            ...
            }), this.onShare = t, this.onLetter = e, this.onRestart = n, this.onMovie = a, this.originStage.addChild(this)
        }, n.prototype.close = function () {
            var t = this.layers;
            t.restart, t.letter, t.share;
            this.originStage.removeChild(this), this.friendDom.style.display = "none", this.movieDom.style.display = "none"
        }, n
    }(egret.DisplayObjectContainer);
    t.Share = e, __reflect(e.prototype, "GAL.Share")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = function () {
        function t() {
            this.scripts = [], this.preRes = null, this.preScripts = [], this.preOffset = []
        }

        return t.prototype.exec = function () {
            this.preRes = this.scripts[this.pointer]() || null
        }, t.prototype.load = function (t, e, n) {
            e ? this.preScripts.push(e) : this.scripts.length && this.preScripts.push(this.scripts), n ? this.preOffset.push(n) : this.scripts.length && this.preOffset.push(this.pointer), this.scripts = t, this.pointer = -1
        }, t.prototype.next = function () {
            if (this.preRes && this.preRes.check && this.preRes.exec) {
                if (!this.preRes.check()) return void this.preRes.exec();
                this.preRes = null
            }
            this.pointer < this.length - 1 ? (this.pointer += 1, this.exec()) : this.preScripts.length && (this.scripts = this.preScripts.pop(), this.pointer = this.preOffset.pop(), this.next())
        }, t.prototype["goto"] = function (t) {
            t >= this.length ? this.pointer = this.length : this.pointer = t, this.exec()
    ...
    t.Interpreter = e, __reflect(e.prototype, "GAL.Interpreter")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = location.href.replace("http", "https"), n = function () {
            ...
            var e = t || navigator.userAgent, n = e.match(/Android\s([0-9\.]*)/);
            return n ? parseFloat(n[1]) : 4
        }, r = /Android/.test(navigator.userAgent), i = /iPad|iPhone|iPod/.test(navigator.userAgent),
        o = /TBS/.test(navigator.userAgent);
    t.config = {
        plat: "pc",
        galaxy: {maxScale: 3, minScale: 1, pinchDistance: 1e3},
        user: null,
        friend: null,
        selectedMaps: [],
        defaultCps: 30,
    ...
    var c = function (e) {
        e && null !== e.alpha && (t.config.plat = "h5"), window.removeEventListener("deviceorientation", c, !1)
    };
...
!function (t) {
    var e = function (e) {
        function n(n) {
            ...
            return a.mode = "ADV", a.bgName = "bg_default", a.position = {x: 0, y: 0}, a.mainPosition = {
                x: 0,
                y: 0
            }, a.offset = {
                x: 0,
                y: 0
            }, a.bgScale = 1, a.animator = new t.Animator, a.createDone = !1, a.direction = "left", a.transition = {
                duration: 1200,
                type: "normal"
            }, a.moveWithChar = !1, a.callback = null, a.updateBg = function (t) {
                var e = a.position, n = e.x, r = e.y;
                a.bgName = "bg_" + t, a.bg.texture = RES.getRes(a.bgName), a.bg.width = a.layers.bg.width = a.bg.texture.textureWidth, a.bg.height = a.layers.bg.height = a.bg.texture.textureHeight, a.offset = {
                    x: (a.stage.stageWidth - a.bg.width) / 2,
                    y: (a.stage.stageHeight - a.bg.height) / 2
                }, a.layers.bg.anchorOffsetX = -a.offset.x, a.layers.bg.anchorOffsetY = -a.offset.y, a.layers.bg.x = n, a.layers.bg.y = r, a.layers.bg.scaleX = a.bgScale, a.layers.bg.scaleY = a.bgScale, a.main.x = 0, a.main.y = 0
            }, a.handleTouch = function () {
                a.interpreter.next()
            }, a.interpreter = n, a.addEventListener(egret.Event.ADDED_TO_STAGE, a.onAddToStage, a), a
        }

        return __extends(n, e), n.prototype.onAddToStage = function () {
            this.width = this.stage.stageWidth, this.height = this.stage.stageHeight, this.layers = {
            ...
            }, this.transitionMask = new egret.Bitmap, this.transitionMask.visible = !1, this.transitionMask.texture = RES.getRes("transition"), this.layer = new egret.DisplayObjectContainer, this.main = new egret.DisplayObjectContainer, this.bg = new egret.Bitmap, this.layer.name = "layer", this.transitionMask.name = "transition", this.main.name = "main", this.layers.bg.name = "bg", this.layers.chars.name = "chars", this.layers.text.name = "text", this.layers.dialog.name = "dialog", this.layers.branch.name = "branch", this.layers.bg.addChild(this.bg), this.main.addChild(this.layers.bg), this.main.addChild(this.layers.chars), this.main.addChild(this.layers.text), this.layer.addChild(this.main), this.layer.addChild(this.layers.branch), this.layer.addChild(this.layers.dialog), this.addChild(this.transitionMask), this.addChild(this.layer)
        }, n.prototype.show = function () {
            var t = this, e = this.callback || function () {
            };
            this.dialog.hide();
            var n = this.position.x, a = this.position.y, r = this.layers.bg,
                i = {x: n, y: a, scaleX: this.bgScale, scaleY: this.bgScale};
            return this.moveWithChar && (n = this.mainPosition.x, a = this.mainPosition.y, r = this.main, i = {
                x: n,
                y: a
            }), this.animation ? (this.animator.init(this.animation, r, function () {
                t.animation = null, e()
            }), this.animator.start(i), {
                check: this.animator.check, exec: function () {
                    t.animator.end(), t.animation = null, e()
                }
            }) : (this.moveWithChar ? (this.main.x = n, this.main.y = a) : (this.layers.bg.x = n, this.layers.bg.y = a), void e())
        }, n.prototype.then = function (t) {
            return void 0 === t && (t = null), this.callback = t, this
        }, n.prototype.toMode = function (e) {
            return this.layers.dialog.contains(this.dialog) && this.layers.dialog.removeChild(this.dialog), this.mode = e, "ADV" === this.mode ? this.dialog = new t.ADVDialog : "NVL" === this.mode && (this.dialog = new t.NVLDialog), this.layers.dialog.addChild(this.dialog), this
        }, n.prototype.create = function (t) {
            var e = this, n = this.callback || function () {
            };
            return this.createDone = !1, "normal" === this.transition.type ? ("left" === this.direction ? this.transitionMask.x = this.stage.width : this.transitionMask.x = -this.transitionMask.width, this.transitionMask.texture = RES.getRes("transition"), this.transitionMask.visible = !0, this.setChildIndex(this.transitionMask, 5), this.animate(this.transition.duration, egret.Ease.quadInOut), this.animator.init(this.animation, this.transitionMask, function () {
                e.clear(), e.updateBg(t), e.animator.init(e.animation, e.transitionMask, function () {
                    e.setChildIndex(e.transitionMask, 0), e.createDone = !0, e.animation = null, e.toMode(e.mode), n()
                });
                var a = 0;
                a = "left" === e.direction ? -e.transitionMask.width : e.stage.width, e.animator.start({x: a})
            }), this.animator.start({x: -100})) : "fade" === this.transition.type ? (this.transitionMask.texture = RES.getRes("transition-w"), this.transitionMask.visible = !0, this.transitionMask.x = 0, this.transitionMask.y = 0, this.animate(this.transition.duration, egret.Ease.quadInOut), this.animator.init(this.animation, this.layer, function () {
                e.clear(), e.updateBg(t), e.animator.init(e.animation, e.layer, function () {
                    e.createDone = !0, e.animation = null, e.toMode(e.mode), n()
                }), e.animator.start({alpha: 1})
            }), this.animator.start({alpha: 0})) : "dissolve" === this.transition.type ? (this.transitionMask.visible = !1, this.animate(this.transition.duration, egret.Ease.quadInOut), this.animator.init(this.animation, this.layer, function () {
                e.clear(), e.updateBg(t), e.animator.init(e.animation, e.layer, function () {
                    e.createDone = !0, e.animation = null, e.toMode(e.mode), n()
                }), e.animator.start({alpha: 1})
            }), this.animator.start({alpha: 0})) : "none" === this.transition.type && (this.clear(), this.updateBg(t), this.createDone = !0, this.animation = null, this.toMode(this.mode), n()), {
                check: function () {
                    return e.createDone
                }, exec: function () {
                }
            ...
            return this.bgScale = t, this
        }, n.prototype.at = function (t, e, n) {
            return void 0 !== n ? this.moveWithChar = n : this.moveWithChar = !1, this.moveWithChar ? (this.mainPosition.x = -t, "number" == typeof e && (this.mainPosition.y = -e)) : (this.position.x = -t, "number" == typeof e && (this.position.y = -e)), this
        }, n.prototype.animate = function (t, e) {
            return void 0 === t && (t = 500), void 0 === e && (e = function (t) {
                return t
            }), this.animation = {duration: t, func: e}, this
            ...
            return void 0 === t && (t = 1200), void 0 === e && (e = "normal"), this.transition = {
                duration: t,
                type: e
            }, this
            ...
            this.layers.chars.removeChildren(), this.hideDialog();
            for (var t = this.layers.branch.numChildren, e = 0; t > e; e += 1) this.layers.text.getChildAt(e).clear();
            t = this.layers.branch.numChildren;
            for (var e = 0; t > e; e += 1) this.layers.branch.getChildAt(e).close();
            return this
    ...
    t.Scene = e, __reflect(e.prototype, "GAL.Scene")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = function (e) {
        function n() {
            ...
            return n.direction = {
                ...
                offset: 24,
                scaleOffset: 0
            }, n.animator = new t.Animator, n.callback = null, n
        }

        return __extends(n, e), n.prototype.addToScene = function (t) {
            this.scene = t, this.texts = [], this.targets = [], this.scene.layers.text.addChild(this)
        }, n.prototype.from = function (t, e, n, a) {
            return void 0 === e && (e = 600), void 0 === n && (n = 24), void 0 === a && (a = 0), this.direction.direction = t, this.direction.duration = e, this.direction.offset = n, this.direction.scaleOffset = a, this
        }, n.prototype.update = function (t) {
            return this.texts = t, this
        }, n.prototype.then = function (t) {
            return void 0 === t && (t = null), this.callback = t, this
        }, n.prototype.draw = function () {
            var t = this, e = this.scene.stage, n = e.stageWidth, a = e.stageHeight;
            this.texts.forEach(function (e) {
                var r = e.text, i = __rest(e, ["text"]), o = new egret.DisplayObjectContainer, c = new egret.TextField;
                if (c.text = r, c.size = i.size || 16, c.width = i.width, c.textAlign = i.textAlign || "center", c.lineSpacing = i.lineSpacing || 8, c.textColor = i.color || 16777215, "number" == typeof i.strokeColor && (c.stroke = 1, c.strokeColor = i.strokeColor), "number" == typeof i.glowColor) {
                    var s = i.glowColor, u = .8, f = 2, h = 2, l = 2, d = 3, g = !1, y = !1,
                        m = new egret.GlowFilter(s, u, f, h, l, d, g, y);
                    c.filters = [m]
                }
                c.anchorOffsetX = c.width / 2, c.anchorOffsetY = c.height / 2, "number" == typeof i.x ? (o.x = i.x, o.x += c.anchorOffsetX) : i.x === egret.HorizontalAlign.CENTER ? o.x = (n - c.width) / 2 : void 0 === i.x && (o.x = n / 2), i.y < 0 ? o.y = a - c.height + i.y : o.y = i.y, o.y += c.anchorOffsetY, c.rotation = i.rotation || 0, c.x = 0, c.y = 0, c.alpha = 0, t.targets.push(c), o.addChild(c), t.addChild(o)
            })
        }, n.prototype.show = function () {
            var t = this.callback || function () {
            }, e = this.direction, n = e.duration, a = e.offset, r = e.direction, i = e.scaleOffset;
            return this.removeChildren(), this.targets = [], this.draw(), this.targets.forEach(function (t) {
                "left" === r ? t.x = -a : "right" === r ? t.x = a : "top" === r ? t.y = -a : "bottom" === r && (t.y = a), i && (t.scaleX = 1 - i, t.scaleY = t.scaleX)
            }), this.animator.init({
                duration: n, func: function (t) {
                    return t
                }
            ...
            var t = this, e = this.callback || function () {
                }, n = this.direction, a = n.duration, r = n.offset, i = n.direction, o = n.scaleOffset, c = 0, s = 0,
                u = 1;
            return "left" === i ? c = r : "right" === i ? c = -r : "top" === i ? s = r : "bottom" === i && (s = -r), o && (u = 1 + o), this.animator.init({
                duration: a,
                func: function (t) {
                    return t
                }
            }, this.targets, function () {
                t.removeChildren(), t.targets = [], e()
            }), this.animator.start({x: c, y: s, alpha: 0, scaleX: u, scaleY: u}), {
                check: this.animator.check,
                exec: this.animator.end
            }
        }, n.prototype.clear = function () {
    ...
    t.Text = e, __reflect(e.prototype, "GAL.Text")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = function (e) {
        function n() {
            ...
            n.layers = {
            ...
            }, n.onConfirm = null, n.onCancel = null, n.isEnd = !1, n.loading = !1, n.handleConfirm = function () {
                if (!n.loading) {
                    var e = n.layers.content;
                    if ("最多十五字哦~" === e.text) return void alert("星空无法理解空白的信息呢~");
                    if (e.text.length > 15) return void alert("星空没有足够的空间去承载超过十五字的内容哦~");
                    n.loading = !0, t.get(t.config.domain.checkComment, {msg: e.text}).then(function (t) {
                        var a = t.data, r = a.code, i = a.data;
                        return 0 !== r ? (alert("留言出现了问题，请重试哦~"), void(n.loading = !1)) : i.level > 10 ? (alert("留言中有不和谐的用语哦，想必对方也不喜欢吧。"), void(n.loading = !1)) : (n.onConfirm(e.text), void(n.loading = !1))
                    })["catch"](function (t) {
                        alert("留言出现了问题，请重试哦~"), n.loading = !1
                    })
                }
                ...
                var e = n.originStage, a = e.stageWidth, r = e.stageHeight, i = n.layers, o = i.bg, c = i.title,
                    s = i.content, u = i.confirm, f = i.cancel, h = 0 === t.config.user.sex ? "她" : "他";
                o.texture = RES.getRes("elements.comment"), u.texture = RES.getRes("elements.confirm"), f.texture = RES.getRes("elements.cancel"), c.text = "在星空上对" + h + "说点什么吧！", singleton.galaxy.count && (c.text += "\n已有" + singleton.galaxy.count + "颗星被点亮"), o.width = a / 5 * 4, o.height = o.texture.textureHeight / o.texture.textureWidth * o.width, n.width = o.width, n.height = o.height, n.x = a / 10, n.y = (r - n.height) / 2, c.width = n.width, c.textAlign = egret.HorizontalAlign.CENTER, c.y = 112, c.textColor = 0, c.size = 25, c.lineSpacing = 8, s.type = egret.TextFieldType.INPUT, s.width = 334, s.height = 90, s.x = (n.width - s.width) / 2, s.y = 192, s.size = 26, s.textColor = 6710886, s.text = "最多十五字哦~", s.maxChars = 15, s.multiline = !0, u.width = 160, u.height = u.texture.textureHeight / u.texture.textureWidth * u.width, u.x = 36, u.y = 320, f.width = u.width, f.height = u.height, f.x = n.width - f.width - 36, f.y = u.y;
                var l = n.y;
                n.alpha = 0, n.y += 32, egret.Tween.get(n).to({alpha: 1, y: l}, 800, egret.Ease.quadInOut)
            };
            var a = n.layers, r = a.bg, i = a.title, o = a.content, c = a.confirm, s = a.cancel;
            return r.name = "bg", i.name = "title", o.name = "content", c.name = "confirm", s.name = "cancel", o.touchEnabled = !0, o.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function () {
                "最多十五字哦~" === o.text && (o.text = ""), o.setFocus()
            }, n), c.touchEnabled = !0, c.addEventListener(egret.TouchEvent.TOUCH_BEGIN, n.handleConfirm, n), s.touchEnabled = !0, s.addEventListener(egret.TouchEvent.TOUCH_BEGIN, n.handleCancel, n), n.addChild(r), n.addChild(i), n.addChild(o), n.addChild(c), n.addChild(s), n
        }
        ...
        return __extends(n, e), n.prototype.addToStage = function (t) {
            ...
            }), this.isEnd = !1, this.onConfirm = t, this.onCancel = e, this.originStage.addChild(this), {
                check: function () {
                    return n.isEnd
                }, exec: function () {
                }
            ...
            var n = this.layers, a = n.confirm, r = n.cancel;
            this.loading = !1, egret.Tween.get(this).to({
                alpha: 0,
                y: this.y - 32
            }, 800, egret.Ease.quadInOut).call(function () {
                a.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, e.handleConfirm, e), r.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, e.handleCancel, e), e.layers.content.text = "最多十五字哦~", e.originStage.contains(e) && (e.originStage.removeChild(e), e.isEnd = !0, t())
            })
        }, n
    }(egret.DisplayObjectContainer);
    t.Comment = e, __reflect(e.prototype, "GAL.Comment")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = 12, n = 16777215, a = 18, r = 16777215, i = 8947848, o = 7, c = 7, s = 570, u = 170, f = o >> 1, h = o >> 1,
        l = function () {
            function l() {
                var e = this;
                this.position = null, this.touchDistance = 0, this.touchEnable = !1, this.orientationManager = new egret.DeviceOrientation, this.orientation = {
                    alpha: 0,
                    gamma: 0,
                    beta: 0
                }, this.starsList = [], this.starsContainerTable = {}, this.startsEnable = !1, this.layers = {
                ...
                }, this.ws = new t.WS, this.count = 0, this.updateStar = function (n) {
                    var a = n.uname, r = n.msg;
                    if (a !== t.config.user.name) {
                        var i = e.layer, f = i.x, h = i.y, l = i.anchorOffsetX, d = i.anchorOffsetY,
                            g = (-f + l) / s + 1, y = (-h + d) / u + 2, m = 1, w = 5;
                        g = ~~(g + (Math.random() - .5) * m), y = ~~(y + (Math.random() - .5) * w), g >= o ? g = o - 1 : 0 > g && (g = 0), y >= c ? y = c - 1 : 0 > y && (y = 0);
                        var p = e.starsContainerTable[g + "-" + y];
                        return p ? void egret.Tween.get(p).to({
                            scaleX: 0,
                            alpha: 0
                        }, 200, egret.Ease.quadInOut).call(function () {
                            e.layers.comments.removeChild(p), e.drawStar({
                                h: g,
                                v: y,
                                x: g * s,
                                y: y * u,
                    ...
                    var n = (t.alpha, t.beta), a = t.gamma;
                    e.orientation = {alpha: 180, beta: n, gamma: a}
                }, this.resetPC = function (t) {
                    e.position.x = t.clientX || t.pageX, e.position.y = t.clientY || t.pageY
                }, this.updatePCXY = function (t) {
                    var n = t.clientX || t.pageX, a = t.clientY || t.pageY;
                    if (!e.position) return void(e.position = {x: n, y: a});
                    var r = e.layer.x + (n - e.position.x) / 5, i = e.layer.y + (a - e.position.y) / 5;
                    e.position.x = n, e.position.y = a;
                    var o = e.bound, c = o.l, s = o.r, u = o.t, f = o.b;
                    r >= c * e.layer.scaleX + e.layer.anchorOffsetX && r <= s + e.layer.anchorOffsetX && (e.layer.x = r), i >= u * e.layer.scaleX + e.layer.anchorOffsetY && i <= f + e.layer.anchorOffsetY && (e.layer.y = i)
                }, this.updatePCZ = function (n) {
                    n.preventDefault(), n.stopPropagation();
                    var a = 0;
                    n.wheelDelta ? a = n.wheelDelta / 3e3 : n.detail && (a = -n.detail / 600);
                    var r = e.layer.scaleX + a;
                    r >= t.config.galaxy.minScale && r <= t.config.galaxy.maxScale && (e.layer.scaleX = r, e.layer.scaleY = r)
                }, this.updateH5XY = function (t) {
                    var n = t.alpha, a = t.beta, r = (t.gamma, e.angleToFactor(n, "alpha")),
                        i = e.angleToFactor(a, "beta"), o = e.bound, c = o.l, s = o.t;
                    e.layer.x = (r * c + e.layer.anchorOffsetX) * e.layer.scaleX, e.layer.y = (i * s + e.layer.anchorOffsetY) * e.layer.scaleX
                }, this.updateH5Z = function (n, a) {
                    void 0 === a && (a = !1);
                    var r = n.distance;
                    if (!e.touchEnable) return e.touchDistance = r, void(e.touchEnable = !0);
                    clearTimeout(e.timeoutId);
                    var i = (r - e.touchDistance) / t.config.galaxy.pinchDistance, o = e.layer.scaleX + i;
                    e.touchDistance = r, o >= t.config.galaxy.minScale && o <= t.config.galaxy.maxScale && (e.layer.scaleX = o, e.layer.scaleY = o), e.timeoutId = setTimeout(function () {
                        e.touchEnable = !1
                    }, 200)
                }
            }
            ...
            return l.prototype.addToScene = function (t) {
                this.scene = t, this.layer = t.layers.bg, this.layers.meteor.name = "meteor", this.layers.moon.name = "moon", this.layers["char"].name = "char", this.layers.bridge.name = "bridge", this.layers.comments.name = "comments"
            }, l.prototype.init = function () {
                this.layer.addChild(this.layers.bridge), this.layer.addChild(this.layers.meteor), this.layer.addChild(this.layers.moon), this.layer.addChild(this.layers["char"]), this.layer.addChild(this.layers.comments);
                var t = this.scene.bg.texture.textureWidth, e = this.scene.bg.texture.textureHeight,
                    n = this.scene.stage.stageWidth, a = this.scene.stage.stageHeight;
                this.bound = {l: n - t, t: a - e, r: 0, b: 0}
            }, l.prototype.show = function (t) {
                void 0 === t && (t = function () {
                }), this.init();
                var e = this.scene.bg.texture.textureWidth, n = this.scene.bg.texture.textureHeight;
                this.scene.stage.stageWidth, this.scene.stage.stageHeight;
                this.next = t;
                var a = this.layers, r = a["char"], i = a.meteor, o = a.moon, c = a.bridge;
                c.texture = RES.getRes("cg.bridge"), r.texture = RES.getRes("cg.2233"), i.texture = RES.getRes("cg.meteor"), o.texture = RES.getRes("cg.moon");
                var s = 2160;
                return c.width = 4 * s / 5 + 200, c.height = c.texture.textureHeight / c.texture.textureWidth * c.width, c.x = (e - c.width) / 2 + 150, c.y = (n - c.height) / 2 + 50, r.width = s / 4, r.height = r.texture.textureHeight / r.texture.textureWidth * r.width, r.x = e / 2, r.y = n / 2, i.width = s / 2, i.height = i.texture.textureHeight / i.texture.textureWidth * i.width, i.x = e / 2, i.y = 300, o.width = s / 4 + 100, o.height = o.texture.textureHeight / o.texture.textureWidth * o.width, o.x = e / 2, o.y = n / 2 - 200, this.animate0(), this
            }, l.prototype.animate0 = function () {
                var t = this, e = this.layers, n = e["char"], a = e.meteor, r = e.moon, i = e.bridge,
                    o = this.scene.bg.texture.textureWidth, c = this.scene.bg.texture.textureHeight;
                n.alpha = 1, r.alpha = 0, a.alpha = 0, i.alpha = 0;
                var s = 2500, u = egret.Tween.get(this.layer), f = egret.Tween.get(n), h = egret.Tween.get(a),
                    l = egret.Tween.get(i), d = egret.Tween.get(r);
                this.scene.unbindTouchEvent(), u.to({x: 0}, 2e3, egret.Ease.quadInOut).to({
                    scaleX: 3,
                    scaleY: 3,
                    x: -2e3,
                    y: -800
                    ...
                    t.next(), t.scene.bindTouchEvent()
                }), l.to({alpha: 1}, 2e3, egret.Ease.quadInOut).wait(1e3).to({
                    x: i.x + 100,
                    y: i.y - 150
                }, 6e3, function (t) {
                    return t
                }), d.to({alpha: 1}, 2e3, egret.Ease.quadInOut).wait(1e3).to({
                    x: r.x + 50,
                    y: r.y - 50
                }, 6e3, function (t) {
                    return t
                }), f.to({x: 1 * o / 2 + 150, y: c / 2 - 200}, 8e3, function (t) {
                    return t
                }), h.to({alpha: 1}, 2e3, egret.Ease.quadInOut), egret.Tween.get({}).wait(1e3).call(function () {
                    return t.next()
                ...
                var a = this.layers, r = a["char"], i = (a.meteor, a.moon), s = a.bridge,
                    u = egret.Tween.get(this.layer), f = egret.Tween.get(r), h = egret.Tween.get(s),
                    l = egret.Tween.get(i), d = [];
                return f.to({y: r.y + 200}, 1e3, egret.Ease.quadInOut), h.to({y: s.y + 250}, 1e3, egret.Ease.quadInOut), l.to({y: i.y + 200}, 1e3, egret.Ease.quadInOut), u.to({y: 500}, 1500, egret.Ease.quadInOut).call(function () {
                    t.get(t.config.domain.comments, {
                        ...
                        var a = t.data, r = a.code, i = a.data;
                        if (0 !== r) return n.mockStars(d), void n.drawStars(e);
                        if (n.count = i.count, d = i.list.map(function (t) {
                                return {user: t.owner.name, content: t.message}
                            }), n.starsList.length <= c * o) n.mockStars(d); else {
                            var s = void 0;
                            if (s = window.crypto ? window.crypto.getRandomValues(new Uint8Array([1]))[0] : 255 * Math.random(), s >= 240) return n.starsList = n.starsList.slice(0, c * o - 30), n.mockStars(d), void n.drawStars(e);
                            n.parseStars(d)
                        }
                        n.drawStars(e)
                    })["catch"](function (t) {
                        n.mockStars(d), n.drawStars(e)
                    })
                }), {
                    check: function () {
                ...
                var e = t.length, n = c * o - e;
                this.starsList = this.parseStars(t.concat([{user: "H光大小姐", content: "本大小姐世界第一可爱！"}, {
                    user: "はやみ",
                    content: "风车的转动，意外有些命运的意味呢~"
                }, {user: "由岐", content: "夏日大三角，伴随着偏在转生的轮回。"}, {user: "樱乃", content: "我只要成为哥哥的空气就好了吧~"}, {
                    user: "夜刀",
                    content: "不会放弃，只因森罗万象之中你最美丽！"
                }, {user: "樱", content: "1095的忧郁之后，初雪，恭喜毕业！"}, {user: "水银", content: "直到我认同的结局到来——"}, {
                    user: "优子",
                    content: "天使也需要休息呢~"
                }, {user: "亮", content: "晚安，Sion。"}, {user: "桔世", content: "夫君，这朝色，是不是有些美呢？"}, {
                    user: "月海",
                    content: "我懂的啊，阿基米德原理什么，所以！"
                }, {user: "凶真", content: "欺骗世界，欺骗自己，只为——"}, {user: "拓已", content: "我就是，我自己！"}, {
                    user: "拓留",
                    content: "我，就是情报弱者啊！"
                }, {user: "悠太", content: "求求你们，请让我，成为英雄吧！"}, {user: "太一", content: "还有人活着吗——我为您祈祷。"}, {
                    user: "历",
                    content: "连自己的青春都拯救不了，这种事我绝不能允许！"
                }, {user: "萤", content: "雨，何时能停。"}, {user: "凯伊姆", content: "人生不如意，十有八九。"}, {
                    user: "朋也",
                    content: "渚，这一次我不会再放开了！"
                }, {user: "往人", content: "旅者的归宿，就这样也不错吧。"}, {user: "尼尔", content: "如果守护不了，不就什么意义都没有了吗？"}, {
                    user: "卓司",
                    content: "我啊，即为世界——"
                }, {user: "篝", content: "演算的终点，是爱啊。"}, {user: "我", content: "四叠半房间之外的世界，更令人雀跃不已。"}, {
                    user: "咩咩",
                    content: "放弃...成为人类吧。"
                }, {user: "当麻", content: "傲慢的神明，让我来粉碎你们的幻想！"}, {
                    user: "干也",
                ...
                for (var e = t.length, n = new Array(e), a = 0, r = 0; c > r; r += 1) {
                    ...
                    for (var l = i * u, d = 0; o > d; d += 1) {
                        ...
                        if (g !== f || i !== h) {
                            if (a >= e) return n;
                            n[a] = {h: g, v: i, x: y, y: l, user: t[a].user, content: t[a].content}, a += 1
                        }
                    }
                }
                return n
                ...
                var e = this;
                void 0 === t && (t = function () {
                }), this.starsContainerTable = {}, 0 === this.starsList.length ? (this.startsEnable = !0, t()) : this.starsList.forEach(function (n, a) {
                    e.drawStar(n, a), a >= e.starsList.length - 2 && (e.startsEnable || t(), e.startsEnable = !0)
                }), this.ws.open(this.updateStar)
            }, l.prototype.drawStar = function (t, o, c) {
                void 0 === c && (c = egret.Ease.backInOut);
                var f = t.h, h = t.v, l = t.x, d = t.y, g = t.user, y = t.content, m = new egret.DisplayObjectContainer,
                    w = new egret.Shape, p = new egret.TextField, x = new egret.Shape, b = new egret.Bitmap;
                b.texture = RES.getRes("cg.star"), b.width = e, b.height = e, w.graphics.lineStyle(1, n), w.graphics.beginFill(n, 1), w.graphics.drawCircle(e / 2, e / 2, e / 2), w.graphics.endFill(), w.alpha = .4;
                var v = 1, A = g + "：" + y;
                A.length > 31 && (A += "…"), A.length > 14 && (p.width = 14 * a, v = 2), p.size = a, p.textColor = r, p.textAlign = egret.HorizontalAlign.LEFT, p.lineSpacing = 4, p.text = g + "：" + y, p.x = e + 12 + 20, 2 === v ? p.y = -p.height / 4 : p.y = 0, x.x = e + 8, x.y = p.y - 8, x.graphics.lineStyle(1, i), x.graphics.beginFill(i, 1), x.graphics.moveTo(0, p.height / 2 + 8), x.graphics.lineTo(20, 0), x.graphics.lineTo(p.x + p.width, 0), x.graphics.lineTo(p.x + p.width, p.height + 16), x.graphics.lineTo(20, p.height + 16), x.graphics.lineTo(0, p.height / 2 + 8), x.graphics.endFill(), x.alpha = .3, m.addChild(w), m.addChild(b), m.addChild(x), m.addChild(p), m.x = l + Math.random() * (s - p.width), m.y = d + Math.random() * (u - p.height), m.name = p.text;
                var S = .5 * Math.random() + .75;
                return m.scaleX = 0, m.scaleY = S, this.layers.comments.addChild(m), 99 !== o ? egret.Tween.get(m).wait(50 * o).to({scaleX: S}, 400, c) : m.scaleX = S, this.starsContainerTable[f + "-" + h] = m, m
            }, l.prototype.addStar = function (e, n, a) {
                void 0 === a && (a = function () {
                });
                var r = f * s, i = h * u, o = this.drawStar({h: f, v: h, x: r, y: i, user: e, content: n}, 99);
                o.alpha = 0, o.y = i + 50, o.scaleX = 1.2, o.scaleY = 1.2;
                var c = egret.Tween.get(this.layer), l = egret.Tween.get(o);
                c.to({
                    x: 50,
                    y: 600
                }, 800, egret.Ease.quadInOut), l.wait(800).to({alpha: 1}, 600, egret.Ease.quadIn).call(function () {
                    return a(n)
                }), t.post(t.config.domain.addComment, {message: n})
            }, l.prototype.reset = function () {
                this.stop(), this.ws.close(), this.starsList = [], this.starsContainerTable = {}, this.startsEnable = !1, this.layer.scaleX = 1, this.layer.scaleY = 1, this.layer.x = 0, this.layer.y = 0, this.layers.comments.removeChildren(), this.layer.removeChild(this.layers.meteor), this.layer.removeChild(this.layers.bridge), this.layer.removeChild(this.layers.moon), this.layer.removeChild(this.layers["char"]), this.layer.removeChild(this.layers.comments)
            }, l.prototype.preWatch = function () {
                return "h5" === t.config.plat && (this.orientationManager.addEventListener(egret.OrientationEvent.CHANGE, this.handlePreWatch, this), this.orientationManager.start()), this
            }, l.prototype.watch = function () {
                var e = this;
                if ("pc" === t.config.plat) document.addEventListener("mousemove", this.updatePCXY), document.addEventListener("mousewheel", this.updatePCZ), document.addEventListener("mouseenter", this.resetPC), document.addEventListener("DOMMouseScroll", this.updatePCZ); else {
                    this.orientationManager.stop(), this.orientationManager.removeEventListener(egret.OrientationEvent.CHANGE, this.handlePreWatch, this), this.orientationManager.addEventListener(egret.OrientationEvent.CHANGE, this.updateH5XY, this), this.orientationManager.start();
                    var n = document.getElementsByTagName("canvas")[0];
                    this.zingTouch = new ZingTouch.Region(n), this.zingTouch.bind(n, "pinch", function (t) {
                        var n = t.detail;
                        return e.updateH5Z(n)
                    }, !1), this.zingTouch.bind(n, "expand", function (t) {
                        var n = t.detail;
                ...
                var a = "alpha" === n ? 360 : 60, r = e;
                "beta" === n && 0 > e && (r = 360 + e);
                var i = (r - this.orientation[n]) / a;
                return "beta" === n && t.config.isIos && !t.config.isQQ && (i = -i), i > .5 && (i = .5), -.5 > i && (i = -.5), "beta" === n && t.config.isIos && !t.config.isQQ ? .5 + i : .5 - i
            }, l.prototype.stop = function () {
                "pc" === t.config.plat ? (document.removeEventListener("mousemove", this.updatePCXY), document.removeEventListener("mousewheel", this.updatePCZ), document.removeEventListener("mouseenter", this.resetPC), document.removeEventListener("DOMMouseScroll", this.updatePCZ)) : (this.orientationManager.stop(), this.orientationManager.removeEventListener(egret.OrientationEvent.CHANGE, this.updateH5XY, this), this.zingTouch.unbind(document.getElementsByTagName("canvas")[0]))
            }, l
        }();
    t.Galaxy = l, __reflect(l.prototype, "GAL.Galaxy")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = function (t) {
        function e() {
            ...
            return e.bg = new egret.Shape, e.progress = new egret.DisplayObjectContainer, e.pgBg = new egret.Shape, e.pgFg = new egret.Shape, e.loaded = !1, e.callback = function () {
            }, e.addEventListener(egret.Event.ADDED_TO_STAGE, e.createView, e), e.addEventListener(egret.Event.REMOVED_FROM_STAGE, e.clear, e), e
        }

        return __extends(e, t), e.prototype.createView = function () {
            var t = this.stage, e = t.stageWidth, n = t.stageHeight;
            this.bg.width = e, this.bg.height = n, this.bg.graphics.beginFill(0, 1), this.bg.graphics.drawRect(0, 0, e, n), this.bg.graphics.endFill(), this.progress.width = 150 * e / 540, this.progress.height = 2, this.progress.x = (e - this.progress.width) / 2, this.progress.y = (n - this.progress.height) / 2 + 100, this.pgBg.width = this.progress.width, this.pgBg.height = this.progress.height / 2, this.pgBg.x = 0, this.pgBg.y = 0, this.pgBg.graphics.beginFill(4806245, 1), this.pgBg.graphics.drawRect(0, 0, this.pgBg.width, this.pgBg.height), this.pgBg.graphics.endFill(), this.pgFg.width = this.pgBg.width, this.pgFg.height = this.progress.height, this.pgFg.x = this.pgBg.x, this.pgFg.y = -this.progress.height / 4, this.progress.addChild(this.pgBg), this.progress.addChild(this.pgFg), this.addChild(this.bg), this.addChild(this.progress)
        }, e.prototype.addToStage = function (t) {
            this.originStage = t, this.originStage.addChild(this)
        }, e.prototype.setProgress = function (t, e) {
            var n = ~~(t / e * this.pgFg.width);
            this.pgFg.graphics.beginFill(16777215, 1), this.pgFg.graphics.drawRoundRect(0, 0, n, this.pgFg.height, 1, 1), this.pgFg.graphics.endFill()
            ...
            console.warn("Group:" + t.groupName + " has failed to load"), this.endFirst()
        }, e.prototype.onResourceProgress = function (t) {
            this.setProgress(t.itemsLoaded, t.itemsTotal)
        }, e.prototype.startFirst = function (t) {
            this.callback = t, RES.addEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.endFirst, this), RES.addEventListener(RES.ResourceEvent.GROUP_LOAD_ERROR, this.onResourceLoadError, this), RES.addEventListener(RES.ResourceEvent.GROUP_PROGRESS, this.onResourceProgress, this), RES.addEventListener(RES.ResourceEvent.ITEM_LOAD_ERROR, this.onItemLoadError, this), RES.loadGroup("preload")
        }, e.prototype.endFirst = function () {
            RES.removeEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.endFirst, this), RES.removeEventListener(RES.ResourceEvent.GROUP_LOAD_ERROR, this.onResourceLoadError, this), RES.removeEventListener(RES.ResourceEvent.GROUP_PROGRESS, this.onResourceProgress, this), RES.removeEventListener(RES.ResourceEvent.ITEM_LOAD_ERROR, this.onItemLoadError, this), document.getElementById("loading").style.display = "none", this.visible = !1, this.callback()
        }, e.prototype.startSecond = function (t) {
            var e = this;
            return void 0 === t && (t = function () {
            }), this.loaded ? void t() : (this.visible = !0, this.loaded = !1, this.callback = t, this.originStage.setChildIndex(this, 10), document.getElementById("loading").style.display = "block", this.pgFg.graphics.clear(), this.bg.alpha = .7, RES.addEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.endSecond, this), RES.addEventListener(RES.ResourceEvent.GROUP_LOAD_ERROR, this.onResourceLoadError, this), RES.addEventListener(RES.ResourceEvent.GROUP_PROGRESS, this.onResourceProgress, this), RES.addEventListener(RES.ResourceEvent.ITEM_LOAD_ERROR, this.onItemLoadError, this), RES.loadGroup("resources"), {
                check: function () {
                    return e.loaded
                }, exec: function () {
                }
            ...
            RES.removeEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.endSecond, this), RES.removeEventListener(RES.ResourceEvent.GROUP_LOAD_ERROR, this.onResourceLoadError, this), RES.removeEventListener(RES.ResourceEvent.GROUP_PROGRESS, this.onResourceProgress, this), RES.removeEventListener(RES.ResourceEvent.ITEM_LOAD_ERROR, this.onItemLoadError, this), this.visible = !1, this.originStage.removeChild(this), this.loaded = !0, this.callback()
        }, e.prototype.clear = function () {
            document.body.removeChild(document.getElementById("loading"))
        }, e
    }(egret.Sprite);
    t.LoadingUI = e, __reflect(e.prototype, "GAL.LoadingUI")
}(GAL || (GAL = {}));
var GAL;
!function (t) {
    var e = function (t) {
        function e() {
            ...
            }, e.initDone = !1, e.callback = null, e.prepare = null, e.animationEnd = !1, e.init = function () {
                var t = e.layers, n = t.bg, a = t.tv, r = t.pan, i = t.logo, o = t.lPin, c = t.sPin, s = e.originStage,
                    u = s.stageWidth, f = s.stageHeight;
                return e.initDone || (a.texture = RES.getRes("npc.tv"), r.texture = RES.getRes("elements.clock-pan"), i.texture = RES.getRes("elements.clock-logo"), o.texture = RES.getRes("elements.clock-pin-l"), c.texture = RES.getRes("elements.clock-pin-s"), n.width = u, n.height = f, n.x = 0, n.y = 0, n.graphics.beginFill(0, 1), n.graphics.drawRect(0, 0, n.width, n.height), n.graphics.endFill(), a.width = 2 * u / 3, a.height = a.texture.textureHeight / a.texture.textureWidth * a.width, a.anchorOffsetX = a.width / 2, a.anchorOffsetY = a.height / 2, a.x = u / 2, a.y = f / 2 - 204, a.rotation = -10, a.alpha = .6, r.width = 2 * u / 3, r.height = r.texture.textureHeight / r.texture.textureWidth * r.width, r.x = (u - r.width) / 2, r.y = (f - r.height) / 2, i.width = 3 * r.width / 5, i.height = i.texture.textureHeight / i.texture.textureWidth * i.width, i.x = (u - i.width) / 2, i.y = (f - i.height) / 2, o.height = r.height, o.width = o.texture.textureWidth / o.texture.textureHeight * o.height, o.anchorOffsetX = o.width / 2, o.anchorOffsetY = o.height / 2, o.x = u / 2, o.y = f / 2, c.height = 4 * r.height / 5, c.width = c.texture.textureWidth / c.texture.textureHeight * c.height, c.anchorOffsetX = c.width / 2, c.anchorOffsetY = c.height / 2, c.x = o.x, c.y = o.y, e.initDone = !0), e.alpha = 0, o.rotation = 0, c.rotation = 0, e.prepare(), e.animate(), {
                    check: function () {
                        return e.animationEnd
                    }, exec: function () {
                    }
            ...
            var n = e.layers, a = n.bg, r = n.tv, i = n.pan, o = n.logo, c = n.lPin, s = n.sPin;
            return a.name = "bg", r.name = "tv", i.name = "pan", o.name = "logo", c.name = "lPin", s.name = "sPin", e.addChild(a), e.addChild(i), e.addChild(o), e.addChild(c), e.addChild(s), e.addChild(r), e
        }

        return __extends(e, t), e.prototype.addToStage = function (t) {
            this.originStage = t, this.addEventListener(egret.Event.ADDED_TO_STAGE, this.init, this)
        }, e.prototype.animate = function () {
            var t = this, e = egret.Tween.get(this), n = egret.Tween.get(this.layers.lPin),
                a = egret.Tween.get(this.layers.sPin);
            e.to({alpha: 1}, 1e3, egret.Ease.quadInOut).wait(1500).to({alpha: 0}, 500, egret.Ease.quadInOut).call(function () {
                t.close()
            }), n.to({rotation: -2160}, 3e3, egret.Ease.quadOut), a.to({rotation: -210}, 3e3, egret.Ease.quadOut)
        }, e.prototype.show = function (t, e) {
            var n = this;
            return void 0 === t && (t = function () {
            }), void 0 === e && (e = function () {
            }), this.animationEnd = !1, this.callback = t, this.prepare = e, this.originStage.addChild(this), {
                check: function () {
            ...
            this.callback(), this.originStage.removeChild(this), this.animationEnd = !0
        }, e
    }(egret.DisplayObjectContainer);
    t.Samsara = e, __reflect(e.prototype, "GAL.Samsara")
}(GAL || (GAL = {}));
var singleton;
!function (t) {
    var e = GAL.config.defaultCps;
    t.loading = new GAL.LoadingUI, t.interpreter = new GAL.Interpreter, t.scene = new GAL.Scene(t.interpreter), t.branch = new GAL.Branch, t.bgm = new GAL.Audio(!1, !0), t.text = new GAL.Text, t.galaxy = new GAL.Galaxy, t.title = new GAL.Title, t.comment = new GAL.Comment, t.share = new GAL.Share, t.samsara = new GAL.Samsara, t.altair = new GAL.Character("altair", "33", "altair", 13770201, 13770201, e), t.vega = new GAL.Character("vega", "22", "vega", 24831, 24831, e), t.boy = new GAL.Character("npc.boy", "少年", "boy", 30884, 30884, e, !1, !1), t.girl = new GAL.Character("npc.girl", "少女", "girl", 16740027, 16740027, e, !1, !1), t.fff = new GAL.Character("npc.fff", "F^3", "fff", 12320768, 12320768, e, !1, !1), t.tv = new GAL.Character("npc.tv", "迷之生物", "npc", 1796608, 1796608, e, !1, !1), t.six = new GAL.Character("npc.six", "66", "npc", 1796608, 1796608, e, !1, !1), t.nine = new GAL.Character("npc.nine", "99", "npc", 1796608, 1796608, e, !1, !1), t.rem = new GAL.Character("npc.rem", "萌王", "npc", 1796608, 1796608, e, !1, !1), t.yato = new GAL.Character("npc.yato", "燃王", "npc", 1796608, 1796608, e, !1, !1), t.tvh = new GAL.Character("npc.tv-h", "河神", "npc", 1796608, 1796608, e, !1, !1), t.up = new GAL.Character("npc.up", "UP评审团", "npc", 1796608, 1796608, e, !1, !1), t.cow = new GAL.Character("npc.cow", "牛", "npc", 1796608, 1796608, e, !1, !1)
}(singleton || (singleton = {}));
var GAL;
!function (t) {
    function e(t, e, n) {
        void 0 === t && (t = r), void 0 === e && (e = i), void 0 === n && (n = "#fff");
        var a = o.join(";"), c = new Image;
    ...
    axios.defaults.withCredentials = !0, t.getCookie = function (t) {
        if (!t) return "";
        var e = "" + document.cookie, n = e.indexOf(t + "=");
        if (-1 === n) return "";
        var a = e.indexOf(";", n);
        return -1 === a && (a = e.length), decodeURIComponent(e.substring(n + t.length + 1, a))
        ...
        void 0 === a && (a = !0);
        var r = n || "";
        return a && (r = t.qsStringify(n)), axios.get(e + "?" + r)
    }, t.post = function (e, n, a) {
        void 0 === a && (a = !0);
        var r = n;
        return r.token = t.getCookie("bili_jct"), a && (r = t.qsStringify(n)), axios.post(e, r)
    }, t.parsePath = function (t) {
        return t.split("").map(function (t) {
            return parseInt(t)
        })
    };
    var n = "888.17.", a = function (t, e, n) {
        void 0 === n && (n = "");
        var a = {
    ...
    t.report = function (t, e, r) {
        ...
        var i = "" + n + t + ".1", o = a(i, r, e);
        axios.get(o)
    }, t.reportPV = function (t) {
        void 0 === t && (t = "");
        var e = document.referrer, a = {
        ...
        return t.get(t.config.domain.info).then(function (e) {
            var n = e.data, a = n.code, r = n.data;
            if (0 === a) {
...
!function (t) {
    ...
    !function (e) {
        e.maps = function () {
            var e = 0 === t.config.user.sex ? "b" : "g", n = ["B", "C", "D"].filter(function (e) {
                return -1 === t.config.selectedMaps.indexOf(e)
            }).map(function (n) {
                return "B" === n ? {
                    content: "", callback: function () {
                        t.branch.from("right"), t.config.selectedMaps.push("B"), t.report("map", "1"), t.interpreter.load(t[e].map1), t.interpreter.next()
                    }, bg: "elements.s1"
                } : "C" === n ? {
                    content: "", callback: function () {
                        t.branch.from("right"), t.config.selectedMaps.push("C"), t.report("map", "2"), t.interpreter.load(t[e].map2), t.interpreter.next()
                    }, bg: "elements.s2"
                } : "D" === n ? {
                    content: "", callback: function () {
                        t.branch.from("right"), t.config.selectedMaps.push("D"), t.report("map", "3"), t.interpreter.load(t[e].map3), t.interpreter.next()
                    }, bg: "elements.s3"
                } : void 0
            });
            return n.length <= 2 && n.push({
                content: "", callback: function () {
                    t.branch.from("right"), t.report("te", 0 === t.config.user.sex ? "boy" : "girl"), t.interpreter.load(t[e].te), t.interpreter.next()
                }, bg: "elements.s4"
            }), t.branch.from("bottom", 24).open(n, !0, {width: 460, x: egret.HorizontalAlign.CENTER})
        }
    }(e = t.branches || (t.branches = {}))
}(scenario || (scenario = {}));
var scenario;
!function (t) {
    t.loading = singleton.loading, t.altair = singleton.altair, t.vega = singleton.vega, t.boy = singleton.boy, t.girl = singleton.girl, t.fff = singleton.fff, t.tv = singleton.tv, t.six = singleton.six, t.nine = singleton.nine, t.rem = singleton.rem, t.yato = singleton.yato, t.tvh = singleton.tvh, t.up = singleton.up, t.cow = singleton.cow, t.scene = singleton.scene, t.bgm = singleton.bgm, t.branch = singleton.branch, t.text = singleton.text, t.interpreter = singleton.interpreter, t.galaxy = singleton.galaxy, t.title = singleton.title, t.comment = singleton.comment, t.share = singleton.share, t.samsara = singleton.samsara, t.config = GAL.config, t.report = GAL.report, t.checkAngle = function (t, e) {
        if (Math.abs(e) > 160) return Math.abs(t) > 160;
        var n = t - e;
        return 0 > n && n >= -20 || n > 0 && 20 >= n
    }, t.loadAndNext = function (e, n, a, r) {
        setTimeout(function () {
            if (t.interpreter.load(e), t.interpreter.next(), "number" == typeof n && "number" == typeof a) {
                var i = r || 0;
        ...
        alert("请先登录哦~"), window.location.href = t.config.domain.login
    }, t.matchFriend = function () {
        var e = t.config.user.path.join("");
        return GAL.post(t.config.domain.match, {path: e}).then(function (e) {
            var n = e.data, a = n.code, r = n.data, i = n.msg;
            return 0 !== a ? (alert("出问题啦，" + i + "，请重试哦~"), t.matchFriend()) : (t.config.friend = {
                id: r.mid,
                name: r.name
            }, void t.next())
        })["catch"](function (e) {
            alert("网络出问题啦，请重试哦~"), t.matchFriend()
        }), {
            check: function () {
        ...
        location.reload(!1), t.config.selectedMaps = [], t.config.friend = null, t.galaxy.reset(), t.share.close(), t.altair.withShow(!1), t.vega.withShow(!1), t.boy.withShow(!1).rename("少年"), t.girl.withShow(!1).rename("少女"), t.fff.withShow(!1), t.loadAndNext(t.intro)
        ...
        map2: {gate: [1e3, 1e3], love: [300, 200], peace: [900, 400], reception: [50, 800], anteroom: [600, -500]},
        map3: {
            entry: [1e3, -1e3],
            brige: [-500, -400],
            river: [0, -800],
...
!function (t) {
    var e = function (e) {
        function n() {
            ...
            return t.visible = !1, t.addEventListener(egret.Event.ADDED_TO_STAGE, t.onAddToStage, t), t
        }

        return __extends(n, e), n.prototype.onAddToStage = function () {
            this.touchIcon = new egret.Bitmap, this.touchIcon.name = "touch", this.touchIcon.texture = RES.getRes(t.DIALOG_SIZE_LUT.touchIcon.bg), this.touchIcon.width = t.DIALOG_SIZE_LUT.touchIcon.width, this.touchIcon.height = this.touchIcon.width * this.touchIcon.texture.textureHeight / this.touchIcon.texture.textureWidth;
            var e = this.stage, n = e.stageWidth, a = e.stageHeight, r = this.width > n ? n : this.width,
                i = this.height > a ? a : this.height;
            this.touchIcon.x = r - this.touchIcon.width - t.DIALOG_SIZE_LUT.touchIcon.right, this.touchIcon.y = i - this.touchIcon.height - t.DIALOG_SIZE_LUT.touchIcon.bottom, this.addChild(this.touchIcon)
    ...
    t.Dialog = e, __reflect(e.prototype, "GAL.Dialog")
}(GAL || (GAL = {}));
var scenario;
!function (t) {
    var e;
    !function (e) {
        var n = t.mapCoords.map3, a = n.entry, r = n.brige, i = n.river, o = n.tree, c = n.room, s = n.yard, u = n.well,
            f = "";
        e.map3 = [function () {
            ...
            return t.branch.open([{
                content: "先往河边走看看吧", callback: function () {
                    return t.loadAndNext(e.d1, 0, 1, 10)
                }
            }, {
                content: "去前面的小屋问问", callback: function () {
            ...
            return t.branch.open([{
                content: "等等，树上似乎画了东西？", callback: function () {
                    return f = "tree", t.loadAndNext(e.d3, 1, 1, 10)
                }
            }, {
                content: "咦，水井边有奇怪的记号？", callback: function () {
                    return f = "well", t.loadAndNext(e.d4, 1, 2, 10)
                }
            }])
        }], e.d2 = [function () {
            ...
            return t.branch.open([{
                content: "先去院子看看", callback: function () {
                    return t.loadAndNext(e.d14, 1, 1, 10)
                }
            }, {
                content: "进屋再说好了", callback: function () {
            ...
            return t.branch.open([{
                content: "感觉可疑，先不管它", callback: function () {
                    return t.loadAndNext(e.d5, 2, 1, 10)
                }
            }, {
                content: "研究标记下的路线图", callback: function () {
            ...
            return t.branch.open([{
                content: "有点好奇，往井口看看", callback: function () {
                    return t.loadAndNext(e.d11, 2, 1, 10)
                }
            }, {
                content: "既然不认识还是别靠近", callback: function () {
            ...
            return t.branch.open([{
                content: "过去问问，说不定知道些什么", callback: function () {
                    return t.loadAndNext(e.d9, 3, 1, 10)
                }
            }, {
                content: "不要接近陌生人为好，往回走", callback: function () {
            ...
            return t.branch.open([{
                content: "把记号和路线销毁", callback: function () {
                    return t.loadAndNext(e.d7, 3, 1, 10)
                }
            }, {
                content: "留下给22的讯息", callback: function () {
            ...
            return t.branch.open([{
                content: "丢失了肌肉33", callback: function () {
                    return t.loadAndNext(e.d12, 3, 1, 10)
                }
            }, {
                content: "丢失了女装33", callback: function () {
                    return t.loadAndNext(e.d12, 3, 2, 10)
                }
            }, {
                content: "丢失了邻家33", callback: function () {
            ...
            return t.branch.open([{
                content: "会引来F^3的，进屋吧", callback: function () {
                    return t.loadAndNext(e.d16, 2, 1, 10)
                }
            }, {
                content: "像是警告，赶快离开这", callback: function () {
                    return t.loadAndNext(e.d5, 2, 2, 10)
                }
            }])
        }], e.d15 = [function () {
            ...
            return t.branch.open([{
                content: "相信自己的直觉！", callback: function () {
                    return t.loadAndNext(e.d19, 2, 1, 10)
                }
            }, {
                content: "万一被F^3利用？", callback: function () {
            ...
            return t.branch.open([{
                content: "为什么觉得哪里倒过来了", callback: function () {
                    return t.loadAndNext(e.d17, 3, 1, 10)
                }
            }, {
                content: "没什么，听起来很幸福呢", callback: function () {
            ...
            return t.branch.open([{
                content: "纳尼，织布的不该是22吗", callback: function () {
                    return t.loadAndNext(e.d17, 3, 1, 10)
                }
            }, {
                content: "没什么，听起来很幸福呢", callback: function () {
...
var Main = function (t) {
    function e() {
        var e = t.call(this) || this;
        return e.bg = new egret.Shape, e.onOrientationchange = function (t) {
            alert("游戏过程中修改横竖屏，可能会造成不可预知的渲染错误。若确实要更改，请刷新~")
        }, GAL.reportPV(), egret.ImageLoader.crossOrigin = "anonymous", GAL.getUserInfo(), e.addEventListener(egret.Event.ADDED_TO_STAGE, e.onAddToStage, e), window.addEventListener("orientationchange", e.onOrientationchange), GAL.config.isAndroid4 && alert("您的手机系统版本过低，可能会出现不可预知的错误，建议升级系统哦~"), e
    }

    return __extends(e, t), e.prototype.onAddToStage = function (t) {
        var e = this.stage, n = e.stageWidth, a = e.stageHeight;
        this.bg.name = "bg", this.bg.width = n, this.bg.height = a, this.bg.graphics.beginFill(0, 1), this.bg.graphics.drawRect(0, 0, n, a), this.bg.graphics.endFill(), singleton.loading.addToStage(this.stage), RES.addEventListener(RES.ResourceEvent.CONFIG_COMPLETE, this.onConfigComplete, this), devMode ? RES.loadConfig("resource/default.res.json", "resource/") : RES.loadConfig("//activity.hdslb.com/blackboard/activity6044/resource/default.res.json", "//activity.hdslb.com/blackboard/activity6044/resource/")
    }, e.prototype.onConfigComplete = function (t) {
        var e = this;
        RES.removeEventListener(RES.ResourceEvent.CONFIG_COMPLETE, this.onConfigComplete, this), singleton.loading.startFirst(function () {
            return e.createGameScene()
        })
    }, e.prototype.createGameScene = function () {
        this.stage.addChild(this.bg), this.stage.addChild(singleton.scene), singleton.altair.addToScene(singleton.scene), singleton.vega.addToScene(singleton.scene), singleton.boy.addToScene(singleton.scene), singleton.girl.addToScene(singleton.scene), singleton.fff.addToScene(singleton.scene), singleton.tv.addToScene(singleton.scene), singleton.six.addToScene(singleton.scene), singleton.nine.addToScene(singleton.scene), singleton.rem.addToScene(singleton.scene), singleton.yato.addToScene(singleton.scene), singleton.tvh.addToScene(singleton.scene), singleton.up.addToScene(singleton.scene), singleton.cow.addToScene(singleton.scene), singleton.branch.addToScene(singleton.scene), singleton.text.addToScene(singleton.scene), singleton.galaxy.addToScene(singleton.scene), singleton.title.addToStage(this.stage), singleton.comment.addToStage(this.stage), singleton.share.addToStage(this.stage), singleton.samsara.addToStage(this.stage), singleton.scene.bindTouchEvent(), singleton.interpreter.load(scenario.intro), singleton.interpreter.next()
    }, e
}(egret.DisplayObjectContainer);
...
!function (t) {
    ...
    !function (e) {
        e.be = [function () {
            return t.scene.clear().toMode("NVL"), t.girl.think("等等，就这么让它们把人带走？")
        }, function () {
            ...
            return t.scene.toMode("ADV"), t.tv.withShow().size("small").from("top", 800).at(3).say("这么说，如果有机会，你愿意再次帮助2233？")
        }, function () {
            return t.girl.say("谁！？")
        }, function () {
            ...
            return t.altair.posture("普通").face("腹黑").size("large").at(3, 0).from("left", 1).show(), t.branches.maps()
        }], e.te = [function () {
            ...
            return t.branch.open([{
                content: "请相信我，无论怎样结局都是……", callback: function () {
                    return t.interpreter.next()
                }
            }, {
                content: "请无视我，我说不定只会坏事……", callback: function () {
                    return t.interpreter.next()
                }
            }])
        }, function () {
            ...
            return t.branch.open([{
                content: "追出门寻找33", callback: function () {
                    return t.loadAndNext(e.te1)
                }
            }, {
                content: "继续留在屋里", callback: function () {
            ...
            return t.branch.open([{
                content: "问33：你怎么回来了？", callback: function () {
                    return t.loadAndNext(e.te4)
                }
            }, {
                content: "问陌生人：你又是……？", callback: function () {
                    return t.loadAndNext(e.te4)
                }
            }])
        }], e.te4 = [function () {
            ...
            return t.branch.open([{
                content: "说起来，白色小电视的来历是？", callback: function () {
                    return t.loadAndNext(e.te5)
                }
            }, {
                content: "说起来，F^3小电视现在在哪？", callback: function () {
                    return t.loadAndNext(e.te5)
                }
            }])
        }], e.te5 = [function () {
            ...
            var e = t.fff.hide(), n = t.tv.withShow().at(8, 1).from("top").say("白色的！！嘿嘿，意不意外？");
            return {
                check: function () {
                    return e.check() && n.check()
                }, exec: function () {
            ...
            return t.branch.open([{
                content: "别擅自卷进其他人来啊！", callback: function () {
                    return t.next()
                }
            }, {
                content: "这是什么腹黑的考验啊！", callback: function () {
                    return t.next()
                }
            }])
        }, function () {
        ...
        e.te6 = [function () {
            ...
            return t.text.then().from("bottom", 600, 12, .1).update([{
                ...
                height: 24,
                size: n
            }, {text: "原案\nH光大小姐", y: -24, width: 192, height: 24, size: a, glowColor: 16777215}]).show()
        }, function () {
            ...
            return t.text.then().update([{
                ...
                height: 24,
                size: n
            }, {text: "出品\nb i l i b i l i", y: -36, width: 192, height: 24, size: 28, glowColor: 16777215}]).show()
        }, function () {
            return t.text.then(function () {
                return t.next()
            }).hide()
            ...
            return t.branch.open([{
                content: "不会吧？", callback: function () {
                    return t.loadAndNext(e.te7)
                }
            }, {
                content: "我也是。", callback: function () {
                    return t.loadAndNext(e.te8)
                }
            }])
        }], e.tegz = [function () {
            return t.scene.toMode("NVL"), t.boy.withShow(!1).say("那个……我好像在哪里见过你。")
        }, function () {
            ...
            return t.branch.open([{
                content: "才不是没有，我只是不谈而已！", callback: function () {
                    return t.next()
                }
            }, {
                content: "你才是！我只是比较热心罢了！", callback: function () {
                    return t.next()
                }
            }])
        }, function () {
            ...
            return t.scene.hideDialog(), t.galaxy.stars(function () {
                return t.next()
            })
        }, function () {
            return t.comment.show(function (e) {
                t.comment.close(function () {
                    t.galaxy.addStar(t.config.user.name, e, function () {
                        return t.config.comment = e, t.share.updateMessage(), t.next()
                    })
                })
            }, function () {
                return t.share.updateMessage(), t.next()
            })
        }, function () {
            return t.share.show(function () {
                ...
                t.jumpMovie()
            }), t.galaxy.preWatch(), "pc" === GAL.config.plat ? (t.galaxy.watch(), void t.branch.close()) : t.branch.open([{
                content: "抬头仰望星空",
                callback: function () {
                    var e = t.galaxy.getOrientation(), n = (e.alpha, e.beta), a = e.gamma;
                    return t.config.isIos && !t.config.isQQ && t.checkAngle(n, 45) && t.checkAngle(a, 180) ? (alert("现在可以观测啦，原地转圈或上下摆动手机可调整视角，双指可进行缩放~"), t.galaxy.watch(), t.branch.close()) : t.checkAngle(n, 135) && t.checkAngle(a, 0) ? (alert("现在可以观测啦，原地转圈或上下摆动手机可调整视角，双指可进行缩放~"), t.galaxy.watch(), t.branch.close()) : void alert("仰望星空需要调整姿势哦，请将手机保持竖屏，HOME键向下，举过头顶调整到合适角度，用其背面对向天空~")
                }
            }], !1)
        }]
    }(e = t.g || (t.g = {}))
...
!function (t) {
    ...
    !function (e) {
        e.intro = [function () {
            ...
            return t.branch.open([{
                content: "点开手机里的“bilibili”", callback: function () {
                    t.interpreter.next()
                }
            }, {
                content: "点开手机里的“相亲APP”", callback: function () {
                    t.interpreter.load([function () {
                        return t.girl.think("系统公告：因开发者失恋，本应用即日起进入不限期停服状态，建议您使用其他大型多人在线分区跨性别交友平台。")
                    }, function () {
                        return t.branch.open([{
                            content: "跳转至“bilibili”", callback: function () {
                                t.interpreter.next()
                            }
                        }])
                    }])
            ...
            return t.branch.open([{
                content: "感到恶意，生气地摔下手机", callback: function () {
                    t.scene["with"]().toMode("ADV"), t.interpreter.next()
                }
            }, {
                content: "受到感召，决定出门装现充", callback: function () {
                    t.scene["with"]().toMode("ADV"), t.interpreter.next()
                }
            }])
        }, function () {
...
!function (t) {
    var e;
    !function (e) {
        var n = t.mapCoords.map1, a = n.gate, r = n.rc, i = n.tent, o = n.ice, c = n.fw, s = n.scale;
        e.map1 = [function () {
            return t.scene.then(function () {
                return t.interpreter.next()
            ...
            return t.branch.open([{
                content: "还是趁没被发现躲开它们吧", callback: function () {
                    t.fff.at(0, 0), t.loadAndNext(e.b1, 0, 1)
                }
            }, {
                content: "偷偷跟着，可能有22的线索", callback: function () {
                    t.fff.at(0, 0).hide(), t.loadAndNext(e.b2, 0, 2)
                }
            }])
        }], e.b1 = [function () {
            ...
            return t.branch.open([{
                content: "直接从大门折返吧", callback: function () {
                    return t.loadAndNext(e.b3, 1, 1)
                }
            }, {
                content: "混进那边的队伍吧", callback: function () {
            ...
            return t.branch.open([{
                content: "不管买雪糕的，跟到帐篷里去", callback: function () {
                    return t.loadAndNext(e.b15, 1, 1)
                }
            }, {
                content: "雪糕站应该安全些，跟过去吧", callback: function () {
            ...
            return t.branch.open([{
                content: "向周围人群呼救！", callback: function () {
                    return t.loadAndNext(e.b6, 2, 1)
                }
            }, {
                content: "大声呼叫保安员！", callback: function () {
            ...
            return t.branch.open([{
                content: "回头会可疑，硬着头皮上", callback: function () {
                    return t.loadAndNext(e.b9, 2, 1)
                }
            }, {
                content: "躲在发车的地方见机行事", callback: function () {
            ...
            return t.branch.open([{
                content: "提出资助F^3们来换取自由", callback: function () {
                    return t.loadAndNext(e.b8, 3, 1)
                }
            }, {
                content: "威胁举报F^3保安骚扰游客", callback: function () {
            ...
            return t.branch.open([{
                content: "冷静下来，先留下33独自逃离", callback: function () {
                    return t.loadAndNext(e.b11, 3, 1)
                }
            }, {
                content: "坚持留下，趁对方虚弱一决高下", callback: function () {
            ...
            return t.branch.open([{
                content: "混入离场的人群走回去", callback: function () {
                    return t.loadAndNext(e.b13, 3, 1)
                }
            }, {
                content: "干脆趁机拷问22的消息", callback: function () {
            ...
            return t.branch.open([{
                content: "调查清楚，靠近台前观察吧", callback: function () {
                    return t.loadAndNext(e.b20, 2, 1)
                }
            }, {
                content: "有点可疑，混在后排人群里", callback: function () {
            ...
            return t.branch.open([{
                content: "别为无聊的事暴露自己！", callback: function () {
                    return t.loadAndNext(e.b17, 2, 1)
                }
            }, {
                content: "有必要叫上保安肃清它们", callback: function () {
                    return t.loadAndNext(e.b6, 2, 2)
                }
            }])
        }], e.b17 = [function () {
            ...
            return t.branch.open([{
                content: "大概只是在顾自游玩而已", callback: function () {
                    return t.loadAndNext(e.b19, 3, 1)
                }
            }, {
                content: "这些F^3或许有什么阴谋", callback: function () {
            ...
            return t.branch.open([{
                content: "别管她！肯定是陷阱", callback: function () {
                    return t.loadAndNext(e.b33, 3, 1)
                }
            }, {
                content: "让她下来！F^3也在", callback: function () {
...
!function (t) {
    var e;
    !function (e) {
        var n = t.mapCoords.map2, a = n.gate, r = n.love, i = n.peace, o = n.reception, c = n.anteroom;
        e.map2 = [function () {
            return t.scene.then(function () {
                return t.interpreter.next()
            ...
            return t.six.rename("66"), t.scene.at(0, 0, !0).animate().show()
        }, function () {
            return t.altair.face("腹黑").say("既然这么问了……不如帮我把F^3小电视都送进黑洞？")
        }, function () {
            return t.branch.open([{
                content: "先在这打听消息吧", callback: function () {
                    return t.loadAndNext(e.c1, 0, 1, 5)
                }
            }, {
                content: "寻找帮手比较实际", callback: function () {
            ...
            return t.branch.open([{
                content: "我们在寻找一个叫22的人……", callback: function () {
                    return t.loadAndNext(e.c3, 1, 1, 5)
                }
            }, {
                content: "有关于F^3小电视的情报吗？", callback: function () {
            ...
            return t.branch.open([{
                content: "门牌写着“LOVE”的房间", callback: function () {
                    return t.loadAndNext(e.c13, 1, 1, 5)
                }
            }, {
                content: "门牌写着”PEACE”的房间", callback: function () {
            ...
            return t.branch.open([{
                content: "不能错过机会，去见一面", callback: function () {
                    return t.loadAndNext(e.c5, 2, 1, 5)
                }
            }, {
                content: "很可能是F^3，躲过它们", callback: function () {
            ...
            return t.branch.open([{
                content: "不能让它们得逞，必须拆穿谎话", callback: function () {
                    return t.loadAndNext(e.c9, 2, 1, 5)
                }
            }, {
                content: "66似乎很喜欢它们，先打听下去", callback: function () {
            ...
            return t.branch.open([{
                content: "阻止33，这样只是自投罗网", callback: function () {
                    return t.loadAndNext(e.c7, 3, 1, 5)
                }
            }, {
                content: "说不定还能找回22，一起去", callback: function () {
            ...
            return t.branch.open([{
                content: "你被F^3耍得团团转，醒醒吧！", callback: function () {
                    return t.loadAndNext(e.c11, 3, 1, 5)
                }
            }, {
                content: "算是事实吧，请帮我们一个忙！", callback: function () {
            ...
            return t.branch.open([{
                ...
                content: "就算是事实吧，请帮我们一个忙", callback: function () {
                    return t.loadAndNext(e.c12, 3, 2, 5)
                }
            }])
        }], e.c10 = [function () {
            ...
            return t.branch.open([{
                content: "其实F^3是拆散情侣的邪恶生物", callback: function () {
                    return t.loadAndNext(e.c11, 3, 1, 5)
                }
            }, {
                content: "33和22因为误会要暂时躲着F^3", callback: function () {
                    return t.loadAndNext(e.c12, 3, 2, 5)
                }
            }])
        }], e.c11 = [function () {
            ...
            var e = t.yato.withShow().at(-6).from("left").show(), n = t.rem.withShow().at(-2).from("left").show();
            return {
                check: function () {
                    return e.check() && n.check()
                }, exec: function () {
            ...
            return t.branch.open([{
                content: "看起来至少不是坏人吧", callback: function () {
                    return t.loadAndNext(e.c15, 2, 1, 5)
                }
            }, {
                content: "完全没办法沟通的样子", callback: function () {
            ...
            return t.branch.open([{
                content: "一定是……蓝色！", callback: function () {
                    return t.loadAndNext(e.c19, 2, 1, 5)
                }
            }, {
                content: "一定是……绿色！", callback: function () {
            ...
            return t.branch.open([{
                content: "也不会有什么损失，先答应吧", callback: function () {
                    return t.loadAndNext(e.c17, 3, 1, 5)
                }
            }, {
                content: "这根本是在趁火打……圈粉吧！", callback: function () {
            ...
            return t.branch.open([{
                content: "屏蔽、拉黑、举报套餐！", callback: function () {
                    return t.loadAndNext(e.c20, 3, 1, 5)
                }
            }, {
                content: "关注、投喂、分享套餐！", callback: function () {
            ...
            return t.branch.open([{
                content: "搭配蛋黄酱或者食醋！", callback: function () {
                    return t.loadAndNext(e.c33, 4, 1, 5)
                }
            }, {
                content: "搭配酱油和大量葱花！", callback: function () {
                    return t.loadAndNext(e.c33, 4, 2, 5)
                }
            }, {
                content: "搭配白糖必须是白糖！", callback: function () {
...
!function (t) {
    ...
    !function (e) {
        e.be = [function () {
            return t.scene.clear().toMode("NVL"), t.boy.think("等等，就这么让它们把人带走？")
        }, function () {
            ...
            return t.vega.posture("普通").face("担心").size("large").at(3, 0).from("left", 1).show(), t.branches.maps()
        }], e.te = [function () {
            return t.matchFriend()
        }, function () {
            ...
            return t.branch.open([{
                content: "追出门寻找22", callback: function () {
                    return t.loadAndNext(e.te1)
                }
            }, {
                content: "继续留在屋里", callback: function () {
            ...
            return t.branch.open([{
                content: "问22：等等，她又是谁？", callback: function () {
                    return t.loadAndNext(e.te4)
                }
            }, {
                content: "问陌生人：你也认识33？", callback: function () {
                    return t.loadAndNext(e.te4)
                }
            }])
        }], e.te4 = [function () {
        ...
        e.te6 = [function () {
            ...
            return t.scene.toMode("NVL"), t.girl.withShow(!1).say("那个……我好像在哪里见过你。")
        }, function () {
...
!function (t) {
    var e = function (e) {
        function n() {
            ...
            return t.blocks = [], t.currentIndex = -1, t.currentTop = 0, t.testText = new egret.TextField, t.innerX = 0, t.innerY = 0, t.animate = function () {
                var e = t.blocks[t.currentIndex];
                if (e.currentCursor === e.wordsLength) return void t.endAnimate();
                var n = Date.now() - e.startTime, a = ~~(n * t.cps / 1e3);
                a !== e.currentCursor && (e.charWords.text = e.words.substr(0, e.currentCursor), e.currentCursor = a), requestAnimationFrame(t.animate)
            }, t.createAnimate = function () {
                var e = t.blocks[t.currentIndex];
                e.currentCursor = 0, e.startTime = Date.now(), e.wordsLength = e.words.length, t.animate()
            }, t.endAnimate = function () {
                var e = t.blocks[t.currentIndex];
                e.currentCursor = e.wordsLength, e.charWords.text = e.words
        ...
        return __extends(n, e), n.prototype.onAddToStage = function () {
            this.bg = new egret.Bitmap, this.bg.name = "bg", this.bg.texture = RES.getRes(t.DIALOG_SIZE_LUT.nvl.bg), this.width = t.DIALOG_SIZE_LUT.nvl.width, this.height = t.DIALOG_SIZE_LUT.nvl.height, this.x = (this.stage.stageWidth - t.DIALOG_SIZE_LUT.nvl.width) / 2, this.y = (this.stage.stageHeight - t.DIALOG_SIZE_LUT.nvl.height) / 2, this.innerX = (t.DIALOG_SIZE_LUT.nvl.width - t.DIALOG_SIZE_LUT.nvl.innerWidth) / 2, this.innerY = (t.DIALOG_SIZE_LUT.nvl.height - t.DIALOG_SIZE_LUT.nvl.innerHeight) / 2, this.testText.width = t.DIALOG_SIZE_LUT.nvl.innerWidth - t.DIALOG_SIZE_LUT.nvl.wordsLeft, this.testText.size = t.DIALOG_SIZE_LUT.nvl.wordsSize, this.testText.lineSpacing = t.DIALOG_SIZE_LUT.nvl.wordsLineSpacing, this.addChild(this.bg), e.prototype.onAddToStage.call(this), this.reset()
            ...
            this.removeChildren(), this.addChild(this.bg), this.addChild(this.touchIcon), this.blocks = [], this.currentTop = this.innerY, this.currentIndex = -1
        }, n.prototype.outWords = function (e, n, a) {
            void 0 === a && (a = !0);
            var r = this.calcBlockHeight(n);
            this.currentTop + r >= t.DIALOG_SIZE_LUT.nvl.innerHeight && this.reset(), this.visible = !0;
            var i = {
            ...
            return this.cps = t.CHAR_ATTRS[e].cps, i.container.y = this.currentTop, i.words = n, i.charWords.size = t.DIALOG_SIZE_LUT.nvl.wordsSize, i.charWords.width = this.testText.width, i.charWords.lineSpacing = t.DIALOG_SIZE_LUT.nvl.wordsLineSpacing, i.charWords.x = this.innerX + t.DIALOG_SIZE_LUT.nvl.wordsLeft, i.charWords.stroke = 1, i.charWords.strokeColor = t.CHAR_ATTRS[e].wordsColor, i.charWords.text = "", a && (i.charName.size = t.DIALOG_SIZE_LUT.nvl.nameSize, i.charName.width = t.DIALOG_SIZE_LUT.nvl.nameWidth, i.charName.stroke = 1, i.charName.strokeColor = t.CHAR_ATTRS[e].nameColor, i.charName.text = t.CHAR_ATTRS[e].name, i.charName.textAlign = egret.HorizontalAlign.LEFT, i.charName.x = this.innerX + t.DIALOG_SIZE_LUT.nvl.nameLeft, i.charWords.y = i.charName.height + t.DIALOG_SIZE_LUT.nvl.wordsTop, r += i.charWords.y, i.container.addChild(i.charName)), i.container.addChild(i.charWords), this.addChild(i.container), this.blocks.push(i), this.currentIndex += 1, this.currentTop += r + t.DIALOG_SIZE_LUT.nvl.blockSpacing, this.createAnimate(), {
            ...
            e.prototype.hide.call(this), this.reset()
        }, n
    }(t.Dialog);
    t.NVLDialog = e, __reflect(e.prototype, "GAL.NVLDialog")
}(GAL || (GAL = {}));
var scenario;
!function (t) {
    t.intro = [function () {
        return singleton.title.init(), t.title.showTitle()
    }, function () {
        return t.config.user ? t.next() : t.login()
    }, function () {
        return t.loading.startSecond(function () {
            t.config.user.path = [9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9], -1 !== t.config.user.sex ? setTimeout(function () {
                return t.interpreter["goto"](4)
            }, 10) : t.next()
        })
    }, function () {
        return t.title.chooseSex(function (e) {
            t.config.user.sex = e, 0 === e ? t.boy.rename(t.config.user.name) : t.girl.rename(t.config.user.name), t.next()
        })
    }, function () {
        t.scene.then().scale(1).at(0, 0)["with"](0, "none").create("white"), t.title.close(), 0 === t.config.user.sex ? (t.boy.rename(t.config.user.name), t.interpreter.load(t.b.intro)) : (t.girl.rename(t.config.user.name), t.interpreter.load(t.g.intro)), t.next()
    }]
}(scenario || (scenario = {}));
var scenario;
!function (t) {
...
!function (t) {
    t.test = [function () {
        ...
        return t.branch.custom().open([{
            content: "我是好人", callback: function () {
                t.interpreter.load(t.s1), t.interpreter.next()
            }, bg: "1", transform: {width: 200, height: 100, x: 120, y: 200, rotation: 30}
        }, {
            content: "我是坏人", callback: function () {
                t.interpreter.load(t.s2), t.interpreter.next()
            }, bg: "2", transform: {width: 200, height: 100, x: 240, y: 400}
        }])
    }, function () {
        return t.scene.create("home")
    }, function () {
    ...
    !function (e) {
        ...
        e.map1 = [function () {
            ...
            return t.branch.open([{
                ...
                content: "偷偷跟着，可能有33的线索", callback: function () {
                    t.fff.at(0, 0).hide(), t.loadAndNext(e.b2, 0, 2)
                }
            }])
        }], e.b1 = [function () {
            ...
            return t.branch.open([{
                content: "提出交易，用门票换22", callback: function () {
                    return t.loadAndNext(e.b7)
                }
            }, {
                content: "凭借身高优势和它们拼了", callback: function () {
                    return t.loadAndNext(e.b7)
                }
            }])
        }], e.b6 = [function () {
            ...
            return t.branch.open([{
                content: "冷静下来，先留下22独自逃离", callback: function () {
                    return t.loadAndNext(e.b11, 3, 1)
                }
            }, {
                content: "坚持留下，趁对方虚弱一决高下", callback: function () {
            ...
            return t.branch.open([{
                ...
                content: "干脆趁机拷问33的消息", callback: function () {
                    return t.loadAndNext(e.b14, 3, 2)
                }
            }])
        }], e.b11 = [function () {
            ...
            return t.branch.open([{
                content: "为了这个暴露自己也很奇怪吧！", callback: function () {
                    return t.loadAndNext(e.b17, 2, 1)
                }
            }, {
                content: "无法忍受！叫来保安教训它们", callback: function () {
                    return t.loadAndNext(e.b6, 2, 2)
                }
            }])
        }], e.b17 = [function () {
            ...
            return t.branch.open([{
                content: "不是和它们赌气的时候吧", callback: function () {
                    return t.loadAndNext(e.b19, 3, 1)
                }
            }, {
                content: "确实，这些家伙真是过分", callback: function () {
                    return t.loadAndNext(e.b19, 3, 2)
                }
            }])
        }], e.b19 = [function () {
            ...
            return t.branch.open([{
                content: "别管他！肯定是FFF小电视的陷阱", callback: function () {
                    return t.loadAndNext(e.b22, 3, 1)
                }
            }, {
                content: "快让他下来！FFF小电视也在附近", callback: function () {
                    return t.loadAndNext(e.b23, 3, 2)
                }
            }])
        }], e.b21 = [function () {
            ...
            return t.branch.open([{
                content: "太可疑了，还是先回台前察看", callback: function () {
                    return t.loadAndNext(e.b20, 3, 1)
                }
            }, {
                content: "肯定有事发生，追出去看看", callback: function () {
...
!function (t) {
    ...
    !function (e) {
        ...
        e.map2 = [function () {
            ...
            return t.branch.open([{
                content: "我们在寻找一个叫33的人……", callback: function () {
                    return t.loadAndNext(e.c3, 1, 1, 5)
                }
            }, {
                content: "有关于F^3小电视的情报吗？", callback: function () {
            ...
            return t.branch.open([{
                content: "阻止22，这样只是自投罗网", callback: function () {
                    return t.loadAndNext(e.c7, 3, 1, 5)
                }
            }, {
                content: "说不定还能找回33，一起去", callback: function () {
                    return t.loadAndNext(e.c8, 3, 2, 5)
                }
            }])
        }], e.c6 = [function () {
            ...
            return t.branch.open([{
                ...
                content: "22和33因为误会要暂时躲着F^3", callback: function () {
                    return t.loadAndNext(e.c12, 3, 2, 5)
                }
            }])
        }], e.c11 = [function () {
            ...
            return t.branch.open([{
                content: "搭配蛋黄酱或者炼乳！", callback: function () {
    ...
    var e = function (e) {
        function n() {
            ...
            return t.animate = function () {
                if (t.currentCursor === t.wordsLength) return void t.endAnimate();
                var e = Date.now() - t.startTime, n = ~~(e * t.cps / 1e3);
                n !== t.currentCursor && (t.charWords.text = t.words.substr(0, t.currentCursor), t.currentCursor = n), requestAnimationFrame(t.animate)
            }, t.createAnimate = function () {
                t.currentCursor = 0, t.startTime = Date.now(), t.wordsLength = t.words.length, t.animate()
            }, t.endAnimate = function () {
                t.currentCursor = t.wordsLength, t.charWords.text = t.words
            }, t.checkAnimationEnd = function () {
        ...
        return __extends(n, e), n.prototype.onAddToStage = function () {
            this.bg = new egret.Bitmap, this.bg.name = "bg", this.charName = new egret.TextField, this.charName.name = "name", this.charName.textAlign = "center", this.charName.stroke = 2, this.charWords = new egret.TextField, this.charWords.name = "words", this.charWords.multiline = !0, this.charWords.stroke = 1, this.width = this.stage.stageWidth, this.height = this.stage.stageWidth * t.DIALOG_SIZE_LUT.adv.height / t.DIALOG_SIZE_LUT.adv.width, this.y = this.stage.stageHeight - t.DIALOG_SIZE_LUT.adv.height, this.charName.textAlign = egret.HorizontalAlign.LEFT, this.charName.x = t.DIALOG_SIZE_LUT.adv.nameLeft, this.charName.size = t.DIALOG_SIZE_LUT.adv.nameSize, this.charName.y = t.DIALOG_SIZE_LUT.adv.nameTop, this.charWords.width = t.DIALOG_SIZE_LUT.adv.wordsWidth, this.charWords.x = t.DIALOG_SIZE_LUT.adv.wordsLeft, this.charWords.y = t.DIALOG_SIZE_LUT.adv.wordsTop, this.charWords.size = t.DIALOG_SIZE_LUT.adv.wordsSize, this.charWords.lineSpacing = t.DIALOG_SIZE_LUT.adv.wordsLineSpacing, this.addChild(this.bg), this.addChild(this.charName), this.addChild(this.charWords), e.prototype.onAddToStage.call(this)
        }, n.prototype.say = function (e, n) {
            return this.visible = !0, this.bg.texture = RES.getRes(t.CHAR_ATTRS[e].bgPath), this.charName.visible = !0, this.charName.text = t.CHAR_ATTRS[e].name, this.charName.strokeColor = t.CHAR_ATTRS[e].nameColor, this.charName.width > t.DIALOG_SIZE_LUT.adv.nameWidth && (this.charName.text = t.CHAR_ATTRS[e].name.substring(0, ~~(t.DIALOG_SIZE_LUT.adv.nameWidth / this.charName.size) + 1)), this.cps = t.CHAR_ATTRS[e].cps, this.words = n, this.charWords.strokeColor = t.CHAR_ATTRS[e].wordsColor, this.charWords.text = "", this.createAnimate(), {
                check: this.checkAnimationEnd,
                exec: this.endAnimate
            }
        }, n.prototype.think = function (e, n) {
            return this.visible = !0, this.bg.texture = RES.getRes(t.CHAR_ATTRS[e].bgThinkPath), this.charName.visible = !1, this.charName.strokeColor = t.CHAR_ATTRS[e].nameColor, this.cps = t.CHAR_ATTRS[e].cps, this.words = n, this.charWords.strokeColor = t.CHAR_ATTRS[e].wordsColor, this.charWords.text = "", this.createAnimate(), {
                check: this.checkAnimationEnd,
                exec: this.endAnimate
            }
        }, n
    }(t.Dialog);
    t.ADVDialog = e, __reflect(e.prototype, "GAL.ADVDialog")
}(GAL || (GAL = {}));
var scenario;
!function (t) {
    var e;
    !function (e) {
        ...
        e.map3 = [function () {
            ...
            return t.branch.open([{
                ...
                content: "留下给33的讯息", callback: function () {
                    return t.loadAndNext(e.d8, 3, 2, 10)
                }
            }])
        }], e.d7 = [function () {
            ...
            return t.branch.open([{
                content: "丢失了女帝22", callback: function () {
                    return t.loadAndNext(e.d12, 3, 1, 10)
                }
            }, {
                content: "丢失了病娇22", callback: function () {
                    return t.loadAndNext(e.d12, 3, 2, 10)
                }
            }, {
                content: "丢失了邻家22", callback: function () {
                    return t.loadAndNext(e.d13, 3, 3, 10)
                }
            }])
        }], e.d12 = [function () {
            ...
            return t.branch.open([{
                content: "不是吧，33不应该放牛吗", callback: function () {
                    return t.loadAndNext(e.d17, 3, 1, 10)
                }
            }, {
                content: "没什么，听起来很幸福呢", callback: function () {
